...
Section "UI screens" SectionUIScreens
	...
	File graphics\ui\cohokum\GCsDriver_Apache\Combat.psd
	File graphics\ui\cohokum\GCsDriver_Apache\Exit.psd
	File graphics\ui\cohokum\GCsDriver_Apache\Main.psd
	File graphics\ui\cohokum\GCsDriver_Apache\Pilots.psd
	File graphics\ui\cohokum\GCsDriver_Apache\Setup.psd

	SetOutPath "$INSTDIR\cohokum\graphics\ui\cohokum\GCsDriver_Hind"

	File graphics\ui\cohokum\GCsDriver_Hind\Combat.psd
	File graphics\ui\cohokum\GCsDriver_Hind\Exit.psd
	File graphics\ui\cohokum\GCsDriver_Hind\Main.psd
	File graphics\ui\cohokum\GCsDriver_Hind\Pilots.psd
	File graphics\ui\cohokum\GCsDriver_Hind\Setup.psd

	SetOutPath "$INSTDIR\cohokum\graphics\ui\cohokum\Original"

	File graphics\ui\cohokum\Original\COMBAT.PSD
	File graphics\ui\cohokum\Original\EXIT.PSD
	File graphics\ui\cohokum\Original\MAIN.PSD
	File graphics\ui\cohokum\Original\PILOTS.PSD
	File graphics\ui\cohokum\Original\SETUP.PSD
