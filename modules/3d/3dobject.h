...
#define MAXIMUM_TRANLUCENT_SURFACES 2048
...
extern translucent_object_surface
	object_3d_translucent_surfaces[];



extern void initialise_object_3d_lookup_tables ( void );
...
extern void calculate_line_normal ( struct OBJECT_3D_INFO *object_base, vec3d *result_normal );

extern void generate_environment_coordinates ( int object_index, object_short_3d_point *point, vec3d *normal, vec3d *camera_position, matrix3x3 attitude, float *u, float*v );
...
extern light_3d_source *generate_relative_lights ( viewpoint *vp, vec3d *object_unit_pos, light_3d_source *lights );

extern void generate_new_environment_coordinates ( int point_index, vec3d *normal, matrix3x3 attitude, float *u, float*v );

extern void generate_object_3d_point_normal ( object_3d_heading_pitch_normal *normal, vec3d *result );
