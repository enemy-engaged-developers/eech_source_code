...
extern void initialise_3d_thailand_terrain_types ( void );

extern void initialise_3d_cuba_terrain_types ( void );

extern void initialise_3d_georgia_terrain_types ( void );
