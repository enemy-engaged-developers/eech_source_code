...
typedef struct TERRAIN_CUSTOM_TYPE terrain_custom_type;

extern terrain_custom_type
   ***customtype;
*/
...
extern void flag_terrain_types ( void );
extern void make_flag_terrain_types ( void );
extern void free_flag_terrain_types ( void );
