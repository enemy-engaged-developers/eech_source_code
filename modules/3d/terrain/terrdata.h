...
struct TERRAIN_3D_CLOUD_PUFF_DATA
{
	float
		x,
		y,
...
typedef struct TERRAIN_3D_CLOUD_PUFF_DATA terrain_3d_cloud_puff_data;

struct TERRAIN_3D_CLOUD_PUFF_SECTOR
{
	int
...
typedef struct TERRAIN_3D_CLOUD_PUFF_SECTOR terrain_3d_cloud_puff_sector;
...
extern terrain_3d_cloud_puff_sector
	**terrain_cloud_puff_sectors;

extern struct OBJECT_3D_INSTANCE
	*terrain_3d_cloud_puff_object;

extern real_colour
	*terrain_3d_cloud_puff_colours;
