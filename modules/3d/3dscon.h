...
extern vertex * construct_3d_surface_gouraud_textured_triangle_fan ( int triangle_index, float specular, int alpha, int base_point, int *polygon_outcode );
...
//
// Reflection map stuff
//

extern vertex * construct_3d_surface_reflective_triangle_fan ( int triangle_index, int base_point, int *polygon_outcode, vec3d *normal );

extern vertex * construct_3d_surface_gouraud_reflective_triangle_fan ( int triangle_index, int base_point, int *polygon_outcode );
