...
extern int advance_texture_animation_frame_on_object ( struct OBJECT_3D_INSTANCE *obj, texture_animation_indices index );

extern int get_texture_animation_number_of_frames ( texture_animation_indices index );
