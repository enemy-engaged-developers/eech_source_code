...
#define	FLOAT_TEXTURE_FACTOR					(100663296.0f)
...
extern void calculate_object_normal_factors ( object_3d_heading_pitch_normal *normals, int number_of_normals, vec3d *camera, struct OBJECT_3D_BOUNDS *bounds, int points_base );
...
extern void illuminate_3d_object_surface ( object_3d *object, vec3d *pos, light_3d_source *lights, vec3d *camera_direction, int points_base );

extern void transform_3d_object_surface ( object_3d *object, vec3d *pos, light_3d_source *lights, vec3d *camera_direction, int points_base );

extern void transform_unclipped_3d_object_surface ( object_3d *object, vec3d *pos, light_3d_source *lights, vec3d *camera_direction, int points_base );
