...
int
	number_of_displacement_maps;

displacement_map
	*displacement_maps = nullptr;



void initialise_3d_displacement_maps ( const char *filename )
{
...
void deinitialise_3d_displacement_maps ( void )
{
	...
	if ( number_of_displacement_maps )
	{
		...
		for ( count = 0; count < number_of_displacement_maps; count++ )
		{
			...
			if ( displacement_maps[count].data )
			{

				safe_free ( displacement_maps[count].data );

				displacement_maps[count].data = NULL;
			}
		}

		safe_free ( displacement_maps );

		displacement_maps = NULL;

		number_of_displacement_maps = 0;
	}
}
