...
typedef struct OBJECT_3D_AMBIENT_LIGHT object_3d_ambient_light;
...
typedef struct OBJECT_3D_DISTANT_LIGHT object_3d_distant_light;
...
typedef struct OBJECT_3D_SUB_OBJECT_SEARCH_BATCH object_3d_sub_object_search_batch;
