...
const double CLOUD_MINIMUM_BLEND_DISTANCE = 16384.0;

const double CLOUD_MAXIMUM_BLEND_DISTANCE = 65536.0;

const double CLOUD_MAXIMUM_COLOUR_BLEND_DISTANCE = 2048.0;
...
static screen
	*current_weather_texture = nullptr,
	*target_weather_texture = nullptr;
