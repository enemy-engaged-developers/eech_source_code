...
void set_file_tag (FILE *file_ptr, char *application_enums [], int tag)
{
...
int get_file_tag (char *line, char *application_enums [], int last_application_enum)
{
...
int get_next_file_tag (FILE *file_ptr, char *application_enums [], int last_application_enum)
{
...
int check_next_file_tag (FILE *file_ptr, char *application_enums [], int last_application_enum)
{
