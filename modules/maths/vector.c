...
vec3d get_global_position_from_unit_vector (vec3d *start_pos, vec3d *unit_vector, float magnitude)
{
	vec3d result_vector;
	...
	result_vector = *unit_vector;
	
	normalise_3d_vector_given_magnitude(&result_vector, 1.0 / magnitude);

	result_vector.x += start_pos->x;
	result_vector.y += start_pos->y;
	result_vector.z += start_pos->z;
