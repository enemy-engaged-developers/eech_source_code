...
extern void get_2d_unit_vector_from_heading(vec2d* result, float heading);
...
extern vec3d get_global_position_from_unit_vector (vec3d *start_pos, vec3d *unit_vector, float magnitude);
