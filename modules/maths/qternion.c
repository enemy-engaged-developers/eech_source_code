...
void slerp_quaternion ( quaternion *result, const quaternion *from, const quaternion *to, float t )
{
...
void multiply_quaternion_by_quaternion ( quaternion *result, const quaternion *q1, const quaternion *q2 )
{
...
void multiply_quaternion_by_vec3d ( vec3d *result, const quaternion *q, const vec3d *v )
{
...
void convert_quaternion_to_matrix3x3 ( matrix3x3 result, const quaternion *q )
{
...
void convert_matrix3x3_to_quaternion ( quaternion *result, const matrix3x3 matrix )
{
