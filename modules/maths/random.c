...
void initialise_random_number_generator (void)
{
	int
		seed;
...
void set_random_number_seed (int seed)
{
	random_number_seed = seed;

	//
	// sync with compiler random number generator
	//
...
int get_random_number_seed (void)
{
