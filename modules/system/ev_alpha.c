...
static void alpha_entry_lowercase (void *event);

static void alpha_entry_uppercase (void *event);

static void end_alpha_entry (void *event);

static void abort_alpha_entry (void *event);
...
void alpha_entry_lowercase (void *ev)
{
...
void alpha_entry_uppercase (void *ev)
{
...
void abort_alpha_entry (void *ev)
{
