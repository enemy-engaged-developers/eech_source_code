...
extern directory_file_list *get_first_directory_file ( char *path );
...
extern FILETIME *get_directory_file_last_write_time ( directory_file_list *list );
...
extern int file_extension ( char *filename, char *extension );
