...
void push_event_overlay (void ((*this_function) (void)), const char *name)
{
	...
	event_stack* stack_item = (event_stack *) safe_malloc (sizeof (event_stack));

	push_event_overlay_with_stack_item(this_function, name, stack_item);
}

void push_event_overlay_with_stack_item(void ((*this_function) (void)), const char *name, event_stack* new_stack_item)
{
...
{
	pop_event_delete(function, TRUE);
}

void pop_event_delete(void ((*function) (void)), int delete_stack_item)
{
