...
extern int destroy_screen ( screen *this_screen );

extern void get_screen_pixel_format ( int *red_mask, int *green_mask, int *blue_mask, int *alpha_mask );

extern int get_screen_pixel_width ( screen *this_screen );

extern void get_screen_rgba_masks ( screen *this_screen, unsigned int *rm, unsigned int *gm, unsigned int *bm, unsigned int *am );

extern int lock_screen ( screen *this_screen );

extern int unlock_screen ( screen *this_screen );
...
extern int set_active_screen ( screen *this_screen );
