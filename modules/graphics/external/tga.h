...
extern void save_tga_image (const char *filename, int width, int height, unsigned char *data);

extern void save_tga_greyscale_image ( const char *filename, int width, int height, unsigned char *data );
