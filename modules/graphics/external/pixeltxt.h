...
extern void initialise_set_texture_pixel_lookup_table ( struct SCREEN *texture );

extern void set_texture_pixel ( struct SCREEN *texture, const int x, const int y, const unsigned int texture_colour, unsigned int texture_alpha );

extern void set_texture_pixel_formats ( void );
...
extern unsigned short int
	set_texture_pixel_lookup_table[];

extern unsigned int
	set_texture_pixel_32bit_lookup_table[];
