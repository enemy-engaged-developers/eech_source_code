...
extern int ddraw_release_objects ( void );

extern int ddraw_attach_palette ( void );

extern int ddraw_set_display_resolution ( int width, int height, int depth, display_types display_type );
