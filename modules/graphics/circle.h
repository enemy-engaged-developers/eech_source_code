...
extern void draw_filled_circle ( float x, float y, float radius, int steps, rgb_colour col );

extern void draw_outline_circle ( float x, float y, float radius, int steps, rgb_colour col );
