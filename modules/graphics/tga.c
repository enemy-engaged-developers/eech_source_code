...
void *load_tga_file (char *filename, short int *width, short int *height, int *bits_per_pixel)
{
...
void *memory_map_tga_file (char *filename, char **memory_mapped_file, short int *width, short int *height, int *bits_per_pixel)
{
...
void save_tga_screen (char *filename)
{
...
void save_tga_screen_with_thumbnail ( char *screen_filename, char *thumbnail_filename )
{
...
void save_tga_image (char *filename, int width, int height, unsigned char *data)
{
...
void save_tga_greyscale_image (char *filename, int width, int height, unsigned char *data)
{
