...
extern LPTLVERTEX get_d3d_vertices_address ( vertex *polygon, int *return_number_of_vertices );

extern LPTLVERTEX get_d3d_vertices_points_address ( int number_of_vertices );

extern LPTLVERTEX get_d3d_new_vertices_points_address ( int number_of_vertices, int *offset );

extern void unroll_d3d_vertices ( int number_of_vertices );

extern LPTLVERTEX get_d3d_line_vertices_points_address ( void );

extern LPTLVERTEX get_d3d_point_vertices_points_address ( int number_of_points );

extern LPTLVERTEX get_d3d_alpha_vertex_buffer_vertices ( int buffer );
