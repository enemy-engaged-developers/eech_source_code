...
//
// This controls the method of rendering each graphics primitive. There are two rendering systems
//
//  1) Hardware rendering. This is the prefered method. Each polygon has RGB colour.
//
//  2) Software rendering. Each polygon has a colour ( CLUT ) and possibly intensity.
//
