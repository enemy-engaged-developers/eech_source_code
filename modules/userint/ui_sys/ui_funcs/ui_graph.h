...
extern void (*fn_set_ui_object_graphic [NUM_UI_TYPES]) (ui_object *obj, unsigned short int *graphic);

extern unsigned short int *(*fn_get_ui_object_graphic [NUM_UI_TYPES]) (ui_object *obj);
...
extern void default_set_ui_object_graphic (ui_object *obj, unsigned short int *graphic);

extern unsigned short int *default_get_ui_object_graphic (ui_object *obj);
