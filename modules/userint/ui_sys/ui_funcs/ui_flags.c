...
void (*fn_set_ui_object_list_box_y_space [NUM_UI_TYPES]) (ui_object *obj, int y_space);

int (*fn_get_ui_object_list_box_y_space [NUM_UI_TYPES]) (ui_object *obj);
...
void set_ui_object_flags_default_functions (void)
{
   ...
   for (i = 0; i < NUM_UI_TYPES; i ++)
   {
      ...
      fn_set_ui_object_list_box_y_space [i] = default_set_ui_object_flag;
      
      fn_get_ui_object_list_box_y_space [i] = default_get_ui_object_flag;
   }
}
