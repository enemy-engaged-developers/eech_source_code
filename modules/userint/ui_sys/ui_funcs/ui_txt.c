...
void (*fn_set_ui_object_font [NUM_UI_TYPES]) (ui_object *obj, int font_id);

int (*fn_get_ui_object_font [NUM_UI_TYPES]) (ui_object *obj);

void (*fn_set_ui_object_hilight_font [NUM_UI_TYPES]) (ui_object *obj, int font_id);

int (*fn_get_ui_object_hilight_font [NUM_UI_TYPES]) (ui_object *obj);
...
void default_set_ui_object_font (ui_object *obj, int font_id)
{
...
int default_get_ui_object_font (ui_object *obj)
{
...
void set_ui_object_text_default_functions (void)
{
	...
	for (i = 0; i < NUM_UI_TYPES; i ++)
	{
		...
		fn_set_ui_object_font [i]				= default_set_ui_object_font;

		fn_get_ui_object_font [i]				= default_get_ui_object_font;

		fn_set_ui_object_hilight_font [i]	= default_set_ui_object_font;

		fn_get_ui_object_hilight_font [i]	= default_get_ui_object_font;
	}
}
