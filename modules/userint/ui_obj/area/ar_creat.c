...
static void create_area_ui_object (ui_object *obj, ui_object_types type, va_list pargs)
{
   ...
   new_area    = safe_malloc (sizeof (area_ui_object));
   ...
   memset (new_area, 0, sizeof (area_ui_object));

   new_area->x = 0.0;
   new_area->y = 0.0;
   new_area->x_size = 0.0;
   new_area->y_size = 0.0;
   new_area->x_origin = 0.0;
   new_area->y_origin = 0.0;
   new_area->drawable = 1;
   new_area->item_number = -1;
   new_area->redraw = 1;
   new_area->text_justify = TEXT_JUSTIFY_CENTRE;
   new_area->state = UI_OBJECT_STATE_OFF;
   new_area->notify_on = NOTIFY_TYPE_BUTTON_UP;
   new_area->moveable = 0;
   new_area->resizeable = 0;
   new_area->parent = NULL;
   new_area->child = NULL;
   new_area->next = NULL;
   new_area->prev = NULL;
   new_area->font_id = -1;
   new_area->hilight_font_id = -1;
   new_area->user_flag1 = 0;
   new_area->user_flag2 = 0;
   new_area->user_flag3 = 0;
   new_area->user_flag4 = 0;
   ...
   ////////////////////////////////////////
	...
	if ( new_area->font_id == -1 )
	{

		new_area->font_id = get_ui_font ();
	}

	if ( new_area->hilight_font_id == -1 )
	{

		new_area->hilight_font_id = new_area->font_id;
	}
