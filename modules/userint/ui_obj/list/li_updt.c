...
static void update_list_ui_object (ui_object *obj)
{
   ...
   area = obj->data;
	...
	//////////////////////////////////////////////////////////////////
	{
		...
		if (count > 100)
		{
			...
			debug_fatal ("LI_UPDT: WARNING: list exceeded 100 items");
		}
	}
	//////////////////////////////////////////////////////////////////
	//
...
void overload_list_ui_object_update_functions (ui_object_types type)
{

	fn_update_ui_object [type] = update_list_ui_object;
}
