	...
	if (screen_stack_head)
	{
		...
		if (screen->area.drawable)
		{
			...
			if (screen->area.child)
			{
				...
				x1 = get_ui_object_x (screen_stack_head) + 1;

				y1 = get_ui_object_y (screen_stack_head) + 1;
		
				x2 = x1 + get_ui_object_x_size (screen_stack_head) - 1;

				y2 = y1 + get_ui_object_y_size (screen_stack_head) - 1;
