...
static void draw_vslider_ui_object (ui_object *obj)
{
	...
	if (get_ui_object_redraw (obj))
	{
		...
		if (lock_screen (active_screen))
		{
			...
			if (get_ui_object_state (obj))
			{
				...
				ui_draw_hilight (x1 + 1, y1 + 1, x2 - 1, y2 - 1);
			}
...
void overload_vslider_ui_object_draw_functions (ui_object_types type)
{

	fn_draw_ui_object [type] = draw_vslider_ui_object;
}
