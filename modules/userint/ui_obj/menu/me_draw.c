...
static void draw_menu_ui_object (ui_object *obj)
{
	...
	if (get_ui_object_redraw (obj))
	{
		...
		if (graphic)
		{
			...
			pretouch_memory ((char *) graphic, x_size * y_size * 2);
		}
...
void overload_menu_ui_object_draw_functions (ui_object_types type)
{

	fn_draw_ui_object [type] = draw_menu_ui_object;
}
