...
static void create_text_ui_object (ui_object *obj, ui_object_types type, va_list pargs)
{
   ...
   new_object    = (text_ui_object *) safe_malloc (sizeof (text_ui_object));
   ...
   memset (new_object, 0, sizeof (text_ui_object));
   ...
   new_object->area.item_number2 = -1;
   ...
   new_object->colour.r = ui_default_colour.r;
   new_object->colour.g = ui_default_colour.g;
   new_object->colour.b = ui_default_colour.b;
   ...
   ////////////////////////////////////////
	...
	//debug_log ("TX_CREAT: created text %s", ((new_object->area.text) ? new_object->area.text : "None set"));
