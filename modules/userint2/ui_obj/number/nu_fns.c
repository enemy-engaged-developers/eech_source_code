...
static void call_number_ui_object_function (ui_object *obj, void *arg)
{
...
static void call_number_ui_object_right_function (ui_object *obj, void *arg)
{
...
void overload_number_ui_object_function_functions (ui_object_types type)
{

	fn_call_ui_object_function [type] 			= call_number_ui_object_function;

	fn_call_ui_object_right_function [type] 	= call_number_ui_object_right_function;
}
