...
static void create_vslider_ui_object (ui_object *obj, ui_object_types type, va_list pargs)
{
   ...
   //new_vslider->area.y_size = 20.0;
	new_vslider->area.colour_start.r = 255;
	new_vslider->area.colour_start.g = 255;
	new_vslider->area.colour_start.b = 255;
	new_vslider->area.colour_start.a = 255;
	new_vslider->area.colour_end.r = 255;
	new_vslider->area.colour_end.g = 255;
	new_vslider->area.colour_end.b = 255;
	new_vslider->area.colour_end.a = 255;
   ...
   set_ui_object_attributes (obj, pargs);
	...
	// create the slider movement object

	py_size = get_screen_height (video_screen) / get_ui_object_y_size (obj);

	slider = create_ui_object (UI_TYPE_AREA,
						UI_ATTR_PARENT (obj),
						UI_ATTR_VIRTUAL_POSITION (0.0, (UI_SLIDER_VIRTUAL_HEIGHT * py_size)),
						UI_ATTR_VIRTUAL_SIZE (1.0, 1.0 - (2.0 * UI_SLIDER_VIRTUAL_HEIGHT * py_size)),
						UI_ATTR_NOTIFY_ON (NOTIFY_TYPE_BUTTON_EITHER),
						UI_ATTR_FUNCTION (ui_object_vslider_function),
						UI_ATTR_HIGHLIGHTABLE (TRUE),
						UI_ATTR_ASSOCIATION (obj),
						UI_ATTR_TEXT ("-"),
						UI_ATTR_END
						);
/*
	// slider sub-objects... done to keep the graphics sweet ;)
	// top of slider movement object

	create_ui_object (UI_TYPE_AREA,
						UI_ATTR_PARENT (slider),
						UI_ATTR_SIZE (UI_SLIDER_VIRTUAL_MOVE_SIZE, UI_SLIDER_VIRTUAL_MOVE_SIZE),
						UI_ATTR_POSITION (2.0, 2.0),
						UI_ATTR_NOTIFY_ON (NOTIFY_TYPE_NONE),
						UI_ATTR_ASSOCIATION (slider),
						UI_ATTR_END
						);

	// middle of slider movement object
	...
	// bottom of slider movement object

	create_ui_object (UI_TYPE_AREA,
						UI_ATTR_PARENT (slider),
						UI_ATTR_SIZE (UI_SLIDER_VIRTUAL_MOVE_SIZE, UI_SLIDER_VIRTUAL_MOVE_SIZE),
						UI_ATTR_POSITION (2.0, py_size - UI_SLIDER_VIRTUAL_MOVE_SIZE - 2.0),
						UI_ATTR_NOTIFY_ON (NOTIFY_TYPE_NONE),
						UI_ATTR_ASSOCIATION (slider),
						UI_ATTR_END
						);
*/
	...
	set_ui_object_association (obj, slider);

	// create up and down buttons

	create_ui_object (UI_TYPE_AREA,
						UI_ATTR_PARENT (obj),
						UI_ATTR_VIRTUAL_SIZE (1.0, UI_SLIDER_VIRTUAL_HEIGHT * py_size),
	...
	create_ui_object (UI_TYPE_AREA,
						UI_ATTR_PARENT (obj),
						UI_ATTR_VIRTUAL_SIZE (1.0, UI_SLIDER_VIRTUAL_HEIGHT * py_size),
						UI_ATTR_VIRTUAL_POSITION (0.0, 1.0 - (UI_SLIDER_VIRTUAL_HEIGHT * py_size)),
