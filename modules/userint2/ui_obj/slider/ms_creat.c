...
static void create_mslider_ui_object (ui_object *obj, ui_object_types type, va_list pargs)
{
   ...
   new_mslider	= (slider_ui_object *) safe_malloc (sizeof (slider_ui_object));
   ...
   //new_mslider->area.y_size = 20.0;
	new_mslider->area.colour_start.r = 255;
	new_mslider->area.colour_start.g = 255;
	new_mslider->area.colour_start.b = 255;
	new_mslider->area.colour_start.a = 255;
	new_mslider->area.colour_end.r = 255;
	new_mslider->area.colour_end.g = 255;
	new_mslider->area.colour_end.b = 255;
	new_mslider->area.colour_end.a = 255;
