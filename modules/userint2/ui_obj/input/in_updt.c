...
static void update_input_ui_object (ui_object *obj)
{
   ...
   if (input->area.drawable)
   {
      ...
      if (input->area.child)
      {
         ...
         update_ui_object (input->area.child);
      }
   }
   ...
   if (input->area.next)
   {
      ...
      if (parent)
      {
		...
		update_ui_object (input->area.next);
	}
...
void overload_input_ui_object_update_functions (ui_object_types type)
{

	fn_update_ui_object [type] = update_input_ui_object;
}
