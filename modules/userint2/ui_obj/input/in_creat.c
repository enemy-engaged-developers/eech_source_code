...
static void create_input_ui_object (ui_object *obj, ui_object_types type, va_list pargs)
{
   ...
   new_object = (input_ui_object*) safe_malloc (sizeof (input_ui_object));
   ...
   memset (new_object, 0, sizeof (input_ui_object));
   ...
   new_object->area.drawable = FALSE;
   ...
   new_object->draw_cursor = TRUE;
   new_object->cursor_timer = 0;
...
void overload_input_ui_object_create_functions (ui_object_types type)
{

	fn_create_ui_object [type] = create_input_ui_object;
}
