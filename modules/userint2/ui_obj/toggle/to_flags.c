...
static void set_toggle_ui_object_state (ui_object *obj, int flag)
{
	...
	if (flag == UI_OBJECT_STATE_HIGHLIGHTED)
	{

		area->state = UI_OBJECT_STATE_HIGHLIGHTED;
	}
	else
	{
		...
		else if (area->state == UI_OBJECT_STATE_OFF)
		{
...
void overload_toggle_ui_object_flag_functions (ui_object_types type)
{

	fn_set_ui_object_state [type] = set_toggle_ui_object_state;
}
