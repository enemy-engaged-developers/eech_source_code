...
void get_text_position (float *x, float *y, float x1, float y1, float x2, float y2, char *text, text_justify_types justify_type)
{
...
void get_text_y_position (float *y, float y1, float y2, char *text, text_justify_types justify_type, int line_count)
{
...
void get_text_x_position (float *x, float x1, float x2, char *text, text_justify_types justify_type)
{
