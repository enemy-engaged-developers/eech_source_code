...
static void create_list_ui_object (ui_object *obj, ui_object_types type, va_list pargs)
{
   ...
   new_object->area.item_number = UI_LIST_NO_SELECTION;
   new_object->area.item_number2 = UI_LIST_NO_SELECTION;
   new_object->area.resizeable = 0;
   new_object->area.notify_on = NOTIFY_TYPE_BUTTON_UP;
   ...
   new_object->y_space = 0;
   new_object->last_position = 0;
