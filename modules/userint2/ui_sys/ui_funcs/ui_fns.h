...
extern void set_ui_object_function_default_functions (void);
...
#define call_ui_object_function(OBJ,STATE) (fn_call_ui_object_function [(OBJ)->type] ((OBJ), (STATE)))

#define set_ui_object_right_function(OBJ,FUNCTION) (fn_set_ui_object_right_function [(OBJ)->type] ((OBJ), (FUNCTION)))

#define get_ui_object_right_function(OBJ) (fn_get_ui_object_right_function [(OBJ)->type] ((OBJ)))

#define call_ui_object_right_function(OBJ,STATE) (fn_call_ui_object_right_function [(OBJ)->type] ((OBJ), (STATE)))

#define set_ui_object_draw_function(OBJ,FUNCTION) (fn_set_ui_object_draw_function [(OBJ)->type] ((OBJ), (FUNCTION)))

#define get_ui_object_draw_function(OBJ) (fn_get_ui_object_draw_function [(OBJ)->type] ((OBJ)))

#define call_ui_object_draw_function(OBJ,STATE) (fn_call_ui_object_draw_function [(OBJ)->type] ((OBJ), (STATE)))

#define set_ui_object_highlighted_function(OBJ,FUNCTION) (fn_set_ui_object_highlighted_function [(OBJ)->type] ((OBJ), (FUNCTION)))

#define get_ui_object_highlighted_function(OBJ) (fn_get_ui_object_highlighted_function [(OBJ)->type] ((OBJ)))

#define call_ui_object_highlighted_function(OBJ,STATE) (fn_call_ui_object_highlighted_function [(OBJ)->type] ((OBJ), (STATE)))
