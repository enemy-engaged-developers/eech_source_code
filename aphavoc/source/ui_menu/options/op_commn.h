...
extern void define_options_screen_common_objects (void);
...
enum OPTION_PAGE_OK_BUTTON_REASON
{
	OPOBR_GRAPHIC_CARD,
	OPOBR_SOUND_DEVICE,
	OPOBR_SOUND_DEVICE_SPEECH
};
typedef enum OPTION_PAGE_OK_BUTTON_REASON option_page_ok_button_reason;
