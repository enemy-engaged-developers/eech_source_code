...
typedef enum {
	MAP_WAYPOINT_CREATED,
	MAP_WAYPOINT_MOVED,
	MAP_WAYPOINT_DELETED
} waypoint_update_action;
...
extern entity* map_add_waypoint (entity *wp1, vec3d *pos, int signal_avionics);
extern void map_delete_waypoint_event ();
