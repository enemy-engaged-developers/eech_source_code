...
void initialise_free_flight_screen_info_objects (void)
{
}
...
void define_free_flight_screen_info_objects (void)
{
	...
	create_ui_object
		(
			...
			UI_ATTR_TEXTURE_GRAPHIC (create_texture_graphic ("graphics\\ui\\cohokum\\map\\fflogbar.psd", 0)),
			UI_ATTR_END
		);
	...
	create_ui_object
		(
			...
			UI_ATTR_VIRTUAL_POSITION (x1, y1),
			UI_ATTR_VIRTUAL_SIZE (x2 - x1, y2 - y1),
			UI_ATTR_TEXTURE_GRAPHIC (create_texture_graphic ("graphics\\ui\\cohokum\\map\\hstrip.psd", 0)),
			UI_ATTR_END
		);
