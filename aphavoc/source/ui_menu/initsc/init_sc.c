...
ui_object
	...
	*copyright_text = nullptr,
	*ah_installed_text = nullptr,
	*initialising_text = nullptr,
	*init_screen = nullptr;
...
void init_function (ui_object *obj, void *arg)
{
	...
	if ( get_ui_object_drawable ( obj ) )
	{
		...
		set_ui_object_texture_graphic (init_screen, create_texture_graphic ("graphics\\ui\\cohokum\\title.psd", 0));
