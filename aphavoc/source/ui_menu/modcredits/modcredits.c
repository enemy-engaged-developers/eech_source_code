...
texture_graphic
	*modcredits_screen_graphic = NULL;
...
void notify_modcredits_screen (ui_object *obj, void *arg)
{
	...
	if ( get_ui_object_drawable ( obj ) )
	{
		...
		if (modcredits_screen_graphic)
		{
		
			destroy_texture_graphic (modcredits_screen_graphic);
	
			modcredits_screen_graphic = NULL;
		}
		
		modcredits_screen_graphic = create_texture_graphic ("graphics\\ui\\cohokum\\Modcredits.psd");
		
		set_ui_object_texture_graphic (modcredits_screen, modcredits_screen_graphic);
