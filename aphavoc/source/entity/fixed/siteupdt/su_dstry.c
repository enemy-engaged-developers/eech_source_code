...
void overload_site_updatable_destroy_functions (void)
{
	fn_destroy_local_entity						[ENTITY_TYPE_SITE_UPDATABLE]								= destroy_local;
	fn_destroy_client_server_entity			[ENTITY_TYPE_SITE_UPDATABLE][COMMS_MODEL_SERVER]	= destroy_server;
	fn_destroy_client_server_entity 			[ENTITY_TYPE_SITE_UPDATABLE][COMMS_MODEL_CLIENT]	= destroy_client;

	fn_destroy_local_entity_family			[ENTITY_TYPE_SITE_UPDATABLE]								= destroy_local;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_SITE_UPDATABLE][COMMS_MODEL_SERVER]	= destroy_server;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_SITE_UPDATABLE][COMMS_MODEL_CLIENT]	= destroy_client;

	fn_kill_local_entity							[ENTITY_TYPE_SITE_UPDATABLE]								= kill_local;
	fn_kill_client_server_entity				[ENTITY_TYPE_SITE_UPDATABLE][COMMS_MODEL_SERVER]	= kill_server;
	fn_kill_client_server_entity				[ENTITY_TYPE_SITE_UPDATABLE][COMMS_MODEL_CLIENT]	= kill_client;
}
