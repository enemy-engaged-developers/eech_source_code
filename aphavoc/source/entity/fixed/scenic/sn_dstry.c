	...
	if (get_comms_model () == COMMS_MODEL_SERVER)
	{
		...
		while (task)
		{
			...
			if (destroy_task->type == ENTITY_TYPE_TASK)
			{
				...
				debug_log ("SN_DSTRY: killing scenic, notifying task %s complete", entity_sub_type_task_names [get_local_entity_int_value (destroy_task, INT_TYPE_ENTITY_SUB_TYPE)]);
...
void overload_scenic_destroy_functions (void)
{
	fn_destroy_local_entity						[ENTITY_TYPE_SCENIC]								= destroy_local;
	fn_destroy_client_server_entity			[ENTITY_TYPE_SCENIC][COMMS_MODEL_SERVER]	= destroy_server;
	fn_destroy_client_server_entity			[ENTITY_TYPE_SCENIC][COMMS_MODEL_CLIENT]	= destroy_client;

	fn_destroy_local_entity_family			[ENTITY_TYPE_SCENIC]		  		  			  	= destroy_local;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_SCENIC][COMMS_MODEL_SERVER]	= destroy_server;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_SCENIC][COMMS_MODEL_CLIENT]	= destroy_client;

	fn_kill_local_entity							[ENTITY_TYPE_SCENIC]		  		  			  	= kill_local;
	fn_kill_client_server_entity				[ENTITY_TYPE_SCENIC][COMMS_MODEL_SERVER]	= kill_server;
	fn_kill_client_server_entity				[ENTITY_TYPE_SCENIC][COMMS_MODEL_CLIENT]	= kill_client;
}
