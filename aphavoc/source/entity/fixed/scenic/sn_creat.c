...
static entity *create_local (entity_types type, int index, char *pargs)
{
	...
	if (en)
	{
   	...
   	//
		...
		raw = (scenic *) malloc_fast_mem (sizeof (scenic));
...
void overload_scenic_create_functions (void)
{
	fn_create_local_entity[ENTITY_TYPE_SCENIC]		  								= create_local;

	fn_create_client_server_entity[ENTITY_TYPE_SCENIC][COMMS_MODEL_SERVER]	= create_server;

	fn_create_client_server_entity[ENTITY_TYPE_SCENIC][COMMS_MODEL_CLIENT]	= create_client;
}
