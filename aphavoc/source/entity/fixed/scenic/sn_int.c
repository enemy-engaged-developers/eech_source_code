...
void overload_scenic_int_value_functions (void)
{
	fn_set_local_entity_raw_int_value		[ENTITY_TYPE_SCENIC][INT_TYPE_DAMAGE_LEVEL]									= set_local_int_value;
	fn_set_local_entity_int_value				[ENTITY_TYPE_SCENIC][INT_TYPE_DAMAGE_LEVEL]									= set_local_int_value;
	fn_set_client_server_entity_int_value	[ENTITY_TYPE_SCENIC][INT_TYPE_DAMAGE_LEVEL][COMMS_MODEL_SERVER]		= set_server_int_value;
	fn_set_client_server_entity_int_value	[ENTITY_TYPE_SCENIC][INT_TYPE_DAMAGE_LEVEL][COMMS_MODEL_CLIENT]		= set_client_int_value;
	fn_get_local_entity_int_value				[ENTITY_TYPE_SCENIC][INT_TYPE_DAMAGE_LEVEL]									= get_local_int_value;
}
