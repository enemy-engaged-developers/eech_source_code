...
void overload_city_building_float_value_functions (void)
{
	fn_get_local_entity_float_value		[ENTITY_TYPE_CITY_BUILDING][FLOAT_TYPE_AVOIDANCE_RADIUS]	= get_local_float_value;
}
