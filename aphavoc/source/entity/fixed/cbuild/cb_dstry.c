...
static void destroy_local (entity *en)
{
	...
	delete_local_entity_from_parents_child_list (en, LIST_TYPE_CITY_BUILDING);
	...
	if (get_comms_model () == COMMS_MODEL_SERVER)
	{
		...
		while (task)
		{
			...
			if (destroy_task->type == ENTITY_TYPE_TASK)
			{
				...
				debug_log ("CB_DSTRY: killing city building, notifying task %s complete", entity_sub_type_task_names [get_local_entity_int_value (destroy_task, INT_TYPE_ENTITY_SUB_TYPE)]);
...
void overload_city_building_destroy_functions (void)
{
	fn_destroy_local_entity						[ENTITY_TYPE_CITY_BUILDING]							= destroy_local;
	fn_destroy_client_server_entity			[ENTITY_TYPE_CITY_BUILDING][COMMS_MODEL_SERVER]	= destroy_server;
	fn_destroy_client_server_entity 			[ENTITY_TYPE_CITY_BUILDING][COMMS_MODEL_CLIENT]	= destroy_client;

	fn_destroy_local_entity_family			[ENTITY_TYPE_CITY_BUILDING]							= destroy_local;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_CITY_BUILDING][COMMS_MODEL_SERVER]	= destroy_server;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_CITY_BUILDING][COMMS_MODEL_CLIENT]	= destroy_client;

	fn_kill_local_entity							[ENTITY_TYPE_CITY_BUILDING]							= kill_local;
	fn_kill_client_server_entity				[ENTITY_TYPE_CITY_BUILDING][COMMS_MODEL_SERVER]	= kill_server;
	fn_kill_client_server_entity				[ENTITY_TYPE_CITY_BUILDING][COMMS_MODEL_CLIENT]	= kill_client;
}
