...
#define NUM_DAMAGE_BITS										(16)
#define NUM_DAY_BITS											(16)
#define NUM_DAY_SEGMENT_TYPE_BITS						(2)
...
#define NUM_ENTITY_SUB_TYPE_BITS							(7)
...
#define NUM_GUNSHIP_TYPE_BITS								(2)
...
#define NUM_META_EXPLOSION_TYPE_BITS					(5)
#define NUM_META_SMOKE_LIST_TYPE_BITS					(5)
...
#define NUM_TASK_COMPLETED_BITS							(2)
...
#define NUM_WAYPOINT_REACHED_BITS						(1)
...
#define get_local_entity_int_value(EN,INT_TYPE) (fn_get_local_entity_int_value[get_local_entity_type ((EN))][validate_int_type ((INT_TYPE))] ((EN), (INT_TYPE)))
