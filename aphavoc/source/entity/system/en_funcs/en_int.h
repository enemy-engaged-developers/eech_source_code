...
enum INT_TYPES
{
	...
	INT_TYPE_ARMOR_PENETRATION_CAPABILITY,
	INT_TYPE_HELICOPTER_DAMAGE_FLAGS,
	INT_TYPE_HELICOPTER_DAMAGE_LEVEL,
	INT_TYPE_HELICOPTER_WEAPON_DAMAGE_FLAGS,
...
#define NUM_TROOPS_ONBOARD_BITS									(4)
...
#define NUM_NDB_FREQUENCY_BITS							(12)
