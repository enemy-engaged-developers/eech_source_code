...
static entity_sides get_vehicle_side (entity_sub_types type)
{
	switch (type)
	{
		...
		case ENTITY_SUB_TYPE_VEHICLE_US_MANPAD:
		case ENTITY_SUB_TYPE_VEHICLE_US_MACHINEGUNNER:
		case ENTITY_SUB_TYPE_VEHICLE_US_LIGHT_FIRING_POINT:
		case ENTITY_SUB_TYPE_VEHICLE_US_MEDIUM_FIRING_POINT:
		case ENTITY_SUB_TYPE_VEHICLE_US_HEAVY_FIRING_POINT:
		{
			return (ENTITY_SIDE_BLUE_FORCE);
		...
		case ENTITY_SUB_TYPE_VEHICLE_RS_MANPAD:
		case ENTITY_SUB_TYPE_VEHICLE_RS_MACHINEGUNNER:
		case ENTITY_SUB_TYPE_VEHICLE_RS_LIGHT_FIRING_POINT:
		case ENTITY_SUB_TYPE_VEHICLE_RS_MEDIUM_FIRING_POINT:
		case ENTITY_SUB_TYPE_VEHICLE_RS_HEAVY_FIRING_POINT:
		{
			return (ENTITY_SIDE_RED_FORCE);
