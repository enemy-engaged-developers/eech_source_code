...
unsigned char *operational_state_names [] =
{
...
unsigned char *verbose_operational_state_names [] =
{
...
unsigned char *group_member_state_names [] =
{
	"Idle",
	"Waiting",
	"Taking Off",
...
unsigned char *keysite_usable_state_names [] =
{
	"Fully Operational",
	"Out Of Action",
	"Repairing",
