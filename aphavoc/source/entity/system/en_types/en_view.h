...
typedef enum VIEW_GROUPS view_groups;

#define view_group_valid(GROUP) (((GROUP) >= VIEW_GROUP_ALL) && ((GROUP) < NUM_VIEW_GROUPS))
...
typedef enum VIEW_SIDES view_sides;

#define view_side_valid(SIDE) (((SIDE) >= VIEW_SIDE_ALL) && ((SIDE) < NUM_VIEW_SIDES))



enum VIEW_CATEGORIES
{
	VIEW_CATEGORY_ALL,
...
typedef enum VIEW_CATEGORIES view_categories;

#define view_category_valid(CATEGORY) (((CATEGORY) >= VIEW_CATEGORY_ALL) && ((CATEGORY) < NUM_VIEW_CATEGORIES))
...
typedef enum VIEW_TYPES view_types;

#define view_type_valid(TYPE) (((TYPE) >= VIEW_TYPE_ALL) && ((TYPE) < NUM_VIEW_TYPES))
