...
#define PACK_ENTIRE_SESSION	0	// premake if change
...
extern int register_entity_list_link_for_post_unpack_validation (struct ENTITY *en, int list_type);
...
extern void dump_entities (void);
