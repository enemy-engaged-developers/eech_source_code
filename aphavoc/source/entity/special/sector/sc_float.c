...
void overload_sector_float_value_functions (void)
{
	fn_get_local_entity_float_value	[ENTITY_TYPE_SECTOR][FLOAT_TYPE_TALLEST_STRUCTURE_HEIGHT]	= get_local_float_value;
}
