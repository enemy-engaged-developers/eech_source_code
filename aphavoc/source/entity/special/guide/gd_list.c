...
#define LIST_TYPE_FOLLOWER_ROOT
...
#define LIST_TYPE_CURRENT_WAYPOINT_LINK

#define LIST_TYPE_GUIDE_LINK

#define LIST_TYPE_GUIDE_STACK_LINK
...
void overload_guide_list_functions (void)
{
	#define TYPE (ENTITY_TYPE_GUIDE)
