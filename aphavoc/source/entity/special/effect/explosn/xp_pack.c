...
static void pack_local_data (entity *en, pack_modes mode)
{
	...
	switch (mode)
	{
		...
		////////////////////////////////////////
		{
			...
			pack_float_value (en, FLOAT_TYPE_EXPLOSION_STATE, raw->explosion_state);
...
static void unpack_local_data (entity *en, entity_types type, pack_modes mode)
{
	...
	switch (mode)
	{
		...
		////////////////////////////////////////
		{
			...
			raw->explosion_state = unpack_float_value (en, FLOAT_TYPE_EXPLOSION_STATE);
...
void overload_explosion_pack_functions (void)
{
	fn_pack_local_entity_data[ENTITY_TYPE_EXPLOSION]		= pack_local_data;

	fn_unpack_local_entity_data[ENTITY_TYPE_EXPLOSION]		= unpack_local_data;
}
