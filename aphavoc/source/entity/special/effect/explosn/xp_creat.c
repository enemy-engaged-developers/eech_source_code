...
static entity *create_local (entity_types type, int index, char *pargs)
{
	...
	if (en)
	{
   	...
   	//
		...
		raw = (explosion *) malloc_fast_mem (sizeof (explosion));
...
void overload_explosion_create_functions (void)
{
	fn_create_local_entity[ENTITY_TYPE_EXPLOSION]		  								= create_local;

//	fn_create_client_server_entity[ENTITY_TYPE_EXPLOSION][COMMS_MODEL_SERVER]	= create_server;

//	fn_create_client_server_entity[ENTITY_TYPE_EXPLOSION][COMMS_MODEL_CLIENT]	= create_client;
}
