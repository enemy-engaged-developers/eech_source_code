...
typedef enum META_SMOKE_LIST_TYPES
{
	META_SMOKE_LIST_TYPE_NONE,
	META_SMOKE_LIST_TYPE_GENERIC_ROCKET_TRAIL,
	META_SMOKE_LIST_TYPE_SMALL_ROCKET_TRAIL,
	META_SMOKE_LIST_TYPE_DECOY_FLARE_TRAIL,
	META_SMOKE_LIST_TYPE_INFINITE_FIRE,
	META_SMOKE_LIST_TYPE_FIRE_SHORT_DURATION,
	META_SMOKE_LIST_TYPE_SMALL_FIRE_SHORT_DURATION,
	...
	META_SMOKE_LIST_TYPE_AIRCRAFT_SMALL_TOUCHDOWN_TRAIL,
	META_SMOKE_LIST_TYPE_AIRCRAFT_LARGE_TOUCHDOWN_TRAIL,

	NUM_META_SMOKE_LIST_TYPES
...
extern void initialise_meta_smoke_list_database();

extern void deinitialise_meta_smoke_list_database();
