...
SMOKE_LIST_DECLARATION({)
	...
	SMOKE_LIST(GREY_TRAIL_SPRITES)
	SMOKE_LIST(WHITE_TRAIL)
	SMOKE_LIST(WHITE_TRAIL_SPRITES)
	...
	SMOKE_LIST(LARGE_WATER_PARTICLE_TRAIL)
	...
	SMOKE_LIST(FLAME_2)
	SMOKE_LIST(FLYING_DIRT)
	SMOKE_LIST(FLYING_DIRT_2)
	SMOKE_LIST(GREY_SMOKE_PUFF)
	SMOKE_LIST(GREY_SMOKE_PUFF_2)
	SMOKE_LIST(DIRT_TRAIL)
	SMOKE_LIST(GUN_SMOKE)
	SMOKE_LIST(GUN_SMOKE_2)
	SMOKE_LIST(FLARE_TRAIL)
	SMOKE_LIST(SPARKS_TRAIL)
