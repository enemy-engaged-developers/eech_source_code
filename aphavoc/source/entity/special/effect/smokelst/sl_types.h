...
META_SMOKE_LIST_DECLARATION({)
	...
	META_SMOKE_LIST(AIRCRAFT_LIGHT_DAMAGE)
	META_SMOKE_LIST(AIRCRAFT_MEDIUM_DAMAGE)
	META_SMOKE_LIST(AIRCRAFT_HEAVY_DAMAGE)
	META_SMOKE_LIST(AIRCRAFT_SMALL_TOUCHDOWN_TRAIL)
	META_SMOKE_LIST(AIRCRAFT_LARGE_TOUCHDOWN_TRAIL)
