...
void overload_smoke_list_float_value_functions (void)
{
	fn_set_local_entity_raw_float_value			[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_FREQUENCY]									= set_local_float_value;
	fn_set_local_entity_float_value				[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_FREQUENCY]									= set_local_float_value;
	fn_set_client_server_entity_float_value	[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_FREQUENCY][COMMS_MODEL_SERVER]		= set_server_float_value;
	fn_set_client_server_entity_float_value	[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_FREQUENCY][COMMS_MODEL_CLIENT]		= set_client_float_value;
	fn_get_local_entity_float_value				[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_FREQUENCY]									= get_local_float_value;

	fn_set_local_entity_raw_float_value			[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_GENERATOR_LIFETIME]								= set_local_float_value;
	fn_set_local_entity_float_value				[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_GENERATOR_LIFETIME]								= set_local_float_value;
	fn_set_client_server_entity_float_value	[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_GENERATOR_LIFETIME][COMMS_MODEL_SERVER]	= set_server_float_value;
	fn_set_client_server_entity_float_value	[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_GENERATOR_LIFETIME][COMMS_MODEL_CLIENT]	= set_client_float_value;
	fn_get_local_entity_float_value				[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_GENERATOR_LIFETIME]								= get_local_float_value;

	fn_set_local_entity_raw_float_value			[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_SMOKE_LIFETIME]							= set_local_float_value;
	fn_set_local_entity_float_value				[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_SMOKE_LIFETIME]							= set_local_float_value;
	fn_set_client_server_entity_float_value	[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_SMOKE_LIFETIME][COMMS_MODEL_SERVER]	= set_server_float_value;
	fn_set_client_server_entity_float_value	[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_SMOKE_LIFETIME][COMMS_MODEL_CLIENT]	= set_client_float_value;
	fn_get_local_entity_float_value				[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_SMOKE_LIFETIME]							= get_local_float_value;

	fn_set_local_entity_raw_float_value			[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_WIDTH_ADJUSTMENT]									= set_local_float_value;
	fn_set_local_entity_float_value				[ENTITY_TYPE_SMOKE_LIST][FLOAT_TYPE_WIDTH_ADJUSTMENT]									= set_local_float_value;
