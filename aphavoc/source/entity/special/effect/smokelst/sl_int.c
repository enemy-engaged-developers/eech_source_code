...
void overload_smoke_list_int_value_functions (void)
{
	fn_set_local_entity_raw_int_value		[ENTITY_TYPE_SMOKE_LIST][INT_TYPE_INFINITE_GENERATOR]								= set_local_int_value;
	fn_set_local_entity_int_value				[ENTITY_TYPE_SMOKE_LIST][INT_TYPE_INFINITE_GENERATOR]								= set_local_int_value;
	fn_set_client_server_entity_int_value	[ENTITY_TYPE_SMOKE_LIST][INT_TYPE_INFINITE_GENERATOR][COMMS_MODEL_SERVER]	= set_server_int_value;
	fn_set_client_server_entity_int_value	[ENTITY_TYPE_SMOKE_LIST][INT_TYPE_INFINITE_GENERATOR][COMMS_MODEL_CLIENT]	= set_client_int_value;
	fn_get_local_entity_int_value				[ENTITY_TYPE_SMOKE_LIST][INT_TYPE_INFINITE_GENERATOR]								= get_local_int_value;

	fn_set_local_entity_raw_int_value		[ENTITY_TYPE_SMOKE_LIST][INT_TYPE_SMOKE_TYPE]										= set_local_int_value;
	fn_set_local_entity_int_value				[ENTITY_TYPE_SMOKE_LIST][INT_TYPE_SMOKE_TYPE]										= set_local_int_value;
