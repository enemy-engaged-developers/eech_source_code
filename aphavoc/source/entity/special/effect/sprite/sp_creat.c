...
static entity *create_local (entity_types type, int index, char *pargs)
{
	...
	if (en)
	{
   	...
   	//
		...
		raw = (sprite *) malloc_fast_mem (sizeof (sprite));
...
void overload_sprite_create_functions (void)
{
	fn_create_local_entity[ENTITY_TYPE_SPRITE]		  								= create_local;

//	fn_create_client_server_entity[ENTITY_TYPE_SPRITE][COMMS_MODEL_SERVER]	= create_server;

//	fn_create_client_server_entity[ENTITY_TYPE_SPRITE][COMMS_MODEL_CLIENT]	= create_client;
}
