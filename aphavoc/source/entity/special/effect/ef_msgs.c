...
static int response_to_set_entity_position (entity_messages message, entity *receiver, entity *sender, va_list pargs)
{
	...
	debug_log ("EFFECT MSGS: setting entity position %f, %f, %f", position->x, position->y, position->z);
...
void overload_effect_message_responses (entity_types type)
{
	#if DEBUG_MODULE >= 2
	...
	message_responses[type][ENTITY_MESSAGE_SET_ENTITY_POSITION]					= response_to_set_entity_position;
}
