...
void overload_particle_message_responses (void)
{
	overload_effect_message_responses (ENTITY_TYPE_PARTICLE);

	#if DEBUG_MODULE

	message_responses[ENTITY_TYPE_PARTICLE][ENTITY_MESSAGE_LINK_CHILD]				= response_to_link_child;

	message_responses[ENTITY_TYPE_PARTICLE][ENTITY_MESSAGE_UNLINK_CHILD]				= response_to_unlink_child;

	message_responses[ENTITY_TYPE_PARTICLE][ENTITY_MESSAGE_LINK_PARENT]				= response_to_link_parent;

	message_responses[ENTITY_TYPE_PARTICLE][ENTITY_MESSAGE_UNLINK_PARENT]			= response_to_unlink_parent;
