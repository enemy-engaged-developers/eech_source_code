...
void overload_particle_destroy_functions (void)
{
	fn_destroy_local_entity						[ENTITY_TYPE_PARTICLE]								= destroy_local;
	fn_destroy_client_server_entity			[ENTITY_TYPE_PARTICLE][COMMS_MODEL_SERVER]	= destroy_server;
	fn_destroy_client_server_entity			[ENTITY_TYPE_PARTICLE][COMMS_MODEL_CLIENT]	= destroy_client;

	fn_destroy_local_entity_family			[ENTITY_TYPE_PARTICLE]								= destroy_local;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_PARTICLE][COMMS_MODEL_SERVER]	= destroy_server;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_PARTICLE][COMMS_MODEL_CLIENT]	= destroy_client;

	fn_kill_local_entity							[ENTITY_TYPE_PARTICLE]								= destroy_local;
	fn_kill_client_server_entity				[ENTITY_TYPE_PARTICLE][COMMS_MODEL_SERVER]	= destroy_server;
	fn_kill_client_server_entity				[ENTITY_TYPE_PARTICLE][COMMS_MODEL_CLIENT]	= destroy_client;
}
