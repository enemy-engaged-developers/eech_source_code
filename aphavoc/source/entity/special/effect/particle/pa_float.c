...
static void set_local_float_value (entity *en, float_types type, float value)
{
	...
	{
		////////////////////////////////////////
		case FLOAT_TYPE_INITIAL_SPEED:
		////////////////////////////////////////
		{
			raw->initial_speed = value;
...
void overload_particle_float_value_functions (void)
{
	////////////////////////////////////////
	//
	...
	fn_set_local_entity_raw_float_value			[ENTITY_TYPE_PARTICLE][FLOAT_TYPE_INITIAL_SPEED]								= set_local_float_value;

	fn_set_local_entity_float_value				[ENTITY_TYPE_PARTICLE][FLOAT_TYPE_INITIAL_SPEED]								= set_local_float_value;

	fn_set_client_server_entity_float_value	[ENTITY_TYPE_PARTICLE][FLOAT_TYPE_INITIAL_SPEED][COMMS_MODEL_SERVER]		= set_server_float_value;
