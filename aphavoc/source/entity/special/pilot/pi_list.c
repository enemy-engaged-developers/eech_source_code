...
#define LIST_TYPE_PILOT_LOCK_ROOT
...
#define LIST_TYPE_AIRCREW_LINK

#define LIST_TYPE_PILOT_LINK

#define LIST_TYPE_PLAYER_TASK_LINK
...
void overload_pilot_list_functions (void)
{
	#define TYPE (ENTITY_TYPE_PILOT)
