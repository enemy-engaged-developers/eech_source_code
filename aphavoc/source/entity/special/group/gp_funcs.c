...
void overload_group_functions (void)
{
	overload_group_create_functions ();

	overload_group_destroy_functions ();
	...
	overload_group_pack_functions ();

	overload_group_ptr_value_functions ();

	overload_group_string_functions ();
