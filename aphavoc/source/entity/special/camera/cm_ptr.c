...
void overload_camera_ptr_value_functions (void)
{
	fn_set_local_entity_ptr_value[ENTITY_TYPE_CAMERA][PTR_TYPE_EXTERNAL_VIEW_ENTITY] = set_local_ptr_value;
	fn_get_local_entity_ptr_value[ENTITY_TYPE_CAMERA][PTR_TYPE_EXTERNAL_VIEW_ENTITY] = get_local_ptr_value;
}
