...
void overload_waypoint_create_functions (void)
{
	fn_create_local_entity[ENTITY_TYPE_WAYPOINT]											= create_local;

	fn_create_client_server_entity[ENTITY_TYPE_WAYPOINT][COMMS_MODEL_SERVER]	= create_server;

	fn_create_client_server_entity[ENTITY_TYPE_WAYPOINT][COMMS_MODEL_CLIENT]	= create_client;
}
