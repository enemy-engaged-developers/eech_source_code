...
static char *get_local_string (entity *en, string_types type)
{
	...
	switch (type)
	{
		...
		////////////////////////////////////////
		{
			s = waypoint_database[raw->sub_type].full_name;
...
void overload_waypoint_string_functions (void)
{
	fn_get_local_entity_string[ENTITY_TYPE_WAYPOINT][STRING_TYPE_FULL_NAME] 				= get_local_string;

	fn_get_local_entity_string[ENTITY_TYPE_WAYPOINT][STRING_TYPE_SHORT_DISPLAY_NAME] 	= get_local_string;
}
