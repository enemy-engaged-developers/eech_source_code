...
static void destroy_local (entity *en)
{
	...
	ASSERT (!raw->force_root.first_child);
...
{
	destroy_local_entity_children (en, LIST_TYPE_FORCE);
...
{
	destroy_client_server_entity_children (en, LIST_TYPE_FORCE);
...
void overload_session_destroy_functions (void)
{
	fn_destroy_local_entity						[ENTITY_TYPE_SESSION]							= destroy_local;
	fn_destroy_client_server_entity			[ENTITY_TYPE_SESSION][COMMS_MODEL_SERVER]	= destroy_server;
	fn_destroy_client_server_entity			[ENTITY_TYPE_SESSION][COMMS_MODEL_CLIENT]	= destroy_client;

	fn_destroy_local_entity_family			[ENTITY_TYPE_SESSION]							= destroy_local_family;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_SESSION][COMMS_MODEL_SERVER]	= destroy_server_family;
	fn_destroy_client_server_entity_family	[ENTITY_TYPE_SESSION][COMMS_MODEL_CLIENT]	= destroy_client_family;

	fn_kill_local_entity							[ENTITY_TYPE_SESSION]							= destroy_local_family;
	fn_kill_client_server_entity				[ENTITY_TYPE_SESSION][COMMS_MODEL_SERVER]	= destroy_server_family;
	fn_kill_client_server_entity				[ENTITY_TYPE_SESSION][COMMS_MODEL_CLIENT]	= destroy_client_family;
}
