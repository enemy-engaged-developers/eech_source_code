...
void overload_regen_vec3d_functions (void)
{
	////////////////////////////////////////
	//
	// VEC3D_TYPE_POSITION
	...
	fn_set_local_entity_raw_vec3d			[ENTITY_TYPE_REGEN][VEC3D_TYPE_POSITION]									= set_local_raw_vec3d;

	fn_set_local_entity_vec3d				[ENTITY_TYPE_REGEN][VEC3D_TYPE_POSITION]									= set_local_vec3d;

	fn_set_client_server_entity_vec3d	[ENTITY_TYPE_REGEN][VEC3D_TYPE_POSITION][COMMS_MODEL_SERVER]			= set_server_vec3d;

	fn_set_client_server_entity_vec3d	[ENTITY_TYPE_REGEN][VEC3D_TYPE_POSITION][COMMS_MODEL_CLIENT]			= set_client_vec3d;

	fn_get_local_entity_vec3d				[ENTITY_TYPE_REGEN][VEC3D_TYPE_POSITION]							 		= get_local_vec3d;

	fn_get_local_entity_vec3d_ptr			[ENTITY_TYPE_REGEN][VEC3D_TYPE_POSITION]									= get_local_vec3d_ptr;
}
