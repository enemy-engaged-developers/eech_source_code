...
// 
		...
		#define MAIN_GUN_BARREL_MIN_PITCH_LIMIT  		(rad (-3.0f))
		#define MAIN_GUN_BARREL_MAX_PITCH_LIMIT  		(rad (68.0))
		...
		////////////////////////////////////////
		{
			// WEAPON PACKAGE 1
			{
				ENTITY_SUB_TYPE_WEAPON_2A65_152MM_ROUND,	 	 		// sub_type
				...
				0,		 			 								  		  		// pitch_share_mask
				MUZZLE_FLASH_LARGE_CALIBRE_FLARED,						// muzzle_flash_type
			},
			// WEAPON PACKAGE 2
			{
