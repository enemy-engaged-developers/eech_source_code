...
// 
		...
		#define LHS_HARDPOINT1							(APACHE_LHS_INNER_PYLON)
		#define RHS_HARDPOINT1 							(APACHE_RHS_INNER_PYLON)
		#define LHS_HARDPOINT2							(APACHE_LHS_OUTER_PYLON)
		#define RHS_HARDPOINT2							(APACHE_RHS_OUTER_PYLON)
		#define LHS_WING_TIP_MOUNT						(APACHE_LHS_WING_TIP_MOUNT)
		#define RHS_WING_TIP_MOUNT						(APACHE_RHS_WING_TIP_MOUNT)
		#define CHAIN_GUN_TURRET						(APACHE_CHAIN_GUN_TURRET)
		#define CHAFF_DISPENSER							(APACHE_CHAFF_DISPENSER)
		#define FLARE_DISPENSER							(APACHE_FLARE_DISPENSER)
		...
		#define CANNON_BARREL_MIN_PITCH_LIMIT		(rad (-60.0f))
		#define CANNON_BARREL_MAX_PITCH_LIMIT		(rad (11.0f))

		#define HYDRA_POD_PITCH_RATE					(rad (20.0f))
		#define HYDRA_POD_MIN_PITCH_LIMIT			(rad (-15.0f))
		#define HYDRA_POD_MAX_PITCH_LIMIT			(rad (4.9f))

		#define HYDRA_POD_ROTATE_INHIBIT_VELOCITY	(knots_to_metres_per_second (100.0f))
