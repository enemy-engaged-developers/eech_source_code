...
// 
		...
		#define NUM_MACHINE_GUN_ROUNDS					(1000)
		#define NUM_SMOKE_GRENADE_ROUNDS					(12)
		...
		#define MAIN_GUN_BARREL_MIN_PITCH_LIMIT  		(rad (-9.0))
		#define MAIN_GUN_BARREL_MAX_PITCH_LIMIT  		(rad (20.0f))
		...
		////////////////////////////////////////
		{
			// WEAPON PACKAGE 1
			{
				ENTITY_SUB_TYPE_WEAPON_M256_120MM_ROUND,	 	 		// sub_type
