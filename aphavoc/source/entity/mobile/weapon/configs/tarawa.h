...
// 
		...
		////////////////////////////////////////
		{
			...
			// WEAPON PACKAGE 4
			{
				ENTITY_SUB_TYPE_WEAPON_SEA_SPARROW,						// sub_type
				8,		  															// number
				2,		  															// heading_depth
				0,																	// pitch_depth
				0,			  														// muzzle_depth
				...
				1,																	// salvo_size
				rad (90.0f),														// heading_rate
				rad (-45.0f),		  											// min_heading_limit
				rad (45.0f),		 		 										// max_heading_limit
				rad (35.0f),														// pitch_rate
				rad (0.0),														// min_pitch_limit
				rad (35.0f),														// max_pitch_limit
				rad (0.0),												 		// muzzle_rotate_rate
				knots_to_metres_per_second (10000.0f),			  		// rotate_inhibit_velocity
				0,		 															// heading_share_mask
				0,		 			 								  	  			// pitch_share_mask
