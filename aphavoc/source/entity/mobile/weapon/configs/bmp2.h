...
// 
		...
		#define SPANDREL_LAUNCHER_TURRET	 				  		(MAIN_GUN_TURRET)
		#define SMOKE_GRENADE_TURRET	 				 			(MAIN_GUN_TURRET)

		#define MAIN_GUN_BARREL	 						  			(0)
		#define SPANDREL_LAUNCHER_BARREL	 				  		(2)
		#define SMOKE_GRENADE_DISPENSER							(1)

		#define NUM_MAIN_GUN_ROUNDS	  					  		(500)
		...
		////////////////////////////////////////
		{
			// WEAPON PACKAGE 1
			{
				ENTITY_SUB_TYPE_WEAPON_2A42_30MM_ROUND,				// sub_type
			...
			// WEAPON PACKAGE 2
			{
				...
				TRUE,		 														// rotate
				1,																	// salvo_size
				SPANDREL_LAUNCHER_TURRET_HEADING_RATE,					// heading_rate
				SPANDREL_LAUNCHER_TURRET_MIN_HEADING_LIMIT,			// min_heading_limit
				SPANDREL_LAUNCHER_TURRET_MAX_HEADING_LIMIT,			// max_heading_limit
				SPANDREL_LAUNCHER_BARREL_PITCH_RATE,	  	 			// pitch_rate
		...
		#undef SPANDREL_LAUNCHER_TURRET_HEADING_RATE
		#undef SPANDREL_LAUNCHER_TURRET_MIN_HEADING_LIMIT
		#undef SPANDREL_LAUNCHER_TURRET_MAX_HEADING_LIMIT
		#undef SPANDREL_LAUNCHER_BARREL_PITCH_RATE
		#undef SPANDREL_LAUNCHER_BARREL_MIN_PITCH_LIMIT
		#undef SPANDREL_LAUNCHER_BARREL_MAX_PITCH_LIMIT
