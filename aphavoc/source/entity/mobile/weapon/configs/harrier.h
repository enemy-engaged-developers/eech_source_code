...
//
		...
		#define LHS_HARDPOINT1	 			(4)
		#define RHS_HARDPOINT1 	 			(5)
		#define LHS_HARDPOINT2				(2)
		#define RHS_HARDPOINT2 				(3)
		#define LHS_HARDPOINT3				(0)
		#define RHS_HARDPOINT3 				(1)
		#define CANNON							(6)
		...
		#define NUM_CANNON_ROUNDS			(300)
		#define NUM_LAU69A_ROCKETS 		(19)
		#define NUM_MAVERICK_MISSILES   (1)
		...
		////////////////////////////////////////
		{
			...
			// WEAPON PACKAGE 5
			{
				ENTITY_SUB_TYPE_WEAPON_GAU12U_25MM_ROUND,				// sub_type
