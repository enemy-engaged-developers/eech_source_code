...
// 
		...
		#define TURRET_MIN_HEADING_LIMIT	(rad (-90.0))
		#define TURRET_MAX_HEADING_LIMIT	(rad (90.0))
		#define LAUNCHER_PITCH_RATE		(rad (20.0))
		#define LAUNCHER_MIN_PITCH_LIMIT	(rad (-10.0))
		#define LAUNCHER_MAX_PITCH_LIMIT	(rad (60.0))
