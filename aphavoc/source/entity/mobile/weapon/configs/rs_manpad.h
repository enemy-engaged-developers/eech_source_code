...
// 
		...
		#define LAUNCHER_HEADING							(0)
		#define RIFLE_HEADING							(1)

		#define NUM_STRELA_MISSILES		(4)
		#define NUM_AK47_AMMO		(30)
		...
		#define LAUNCHER_MIN_PITCH_LIMIT	(rad (-5.0))
		...
		////////////////////////////////////////
		{
			// WEAPON PACKAGE 1
			{
				...
				NUM_STRELA_MISSILES,		 								// number
				LAUNCHER_HEADING,			 	 											// heading_depth
				0,	 	 	 											// pitch_depth
				0,					  												// muzzle_depth
			...
			// WEAPON PACKAGE 2
			{
				ENTITY_SUB_TYPE_WEAPON_AK_47_7P62MM_ROUND,	  				// sub_type
				NUM_AK47_AMMO,		 								// number
				RIFLE_HEADING,			 	 											// heading_depth
				0,	 	 	 											// pitch_depth
				0,					  												// muzzle_depth
				FALSE,			  												// make_weapon_system_ready
				TRUE,		 														// rotate
		...
		#undef LAUNCHER_HEADING
		#undef RIFLE_HEADING

		#undef NUM_STRELA_MISSILES
		#undef NUM_AK47_AMMO
