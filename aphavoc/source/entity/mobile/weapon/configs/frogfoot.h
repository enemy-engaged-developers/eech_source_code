...
//
		...
		#define LHS_HARDPOINT4	  		(6)
		#define RHS_HARDPOINT4	  		(7)
		#define LHS_HARDPOINT5	  		(8)
		#define RHS_HARDPOINT5	  		(9)
		#define CANNON			  			(10)
		...
		#undef LHS_HARDPOINT5
		#undef RHS_HARDPOINT5
		#undef CANNON
