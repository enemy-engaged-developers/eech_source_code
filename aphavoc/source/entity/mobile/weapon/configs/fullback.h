...
//
		...
		#define MIDL_HARDPOINT	 			(3)
		#define MIDR_HARDPOINT	 	 		(2)
		#define LHS_HARDPOINT1	 			(5)
		#define RHS_HARDPOINT1 	 			(4)
		#define LHS_HARDPOINT2				(7)
		#define RHS_HARDPOINT2 				(6)
		#define LHS_HARDPOINT3				(9)
		#define RHS_HARDPOINT3 				(8)
		#define LHS_WING_TIP_MOUNT			(11)
		#define RHS_WING_TIP_MOUNT			(10)
		#define CANNON							(12)
		...
		#undef MIDR_HARDPOINT
		#undef MIDL_HARDPOINT
