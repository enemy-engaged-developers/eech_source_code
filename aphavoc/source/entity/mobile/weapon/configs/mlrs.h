...
// 
		...
		#define TURRET_HEADING_RATE 		(rad (45.0))
		#define TURRET_MIN_HEADING_LIMIT	(rad (-180.0))
		#define TURRET_MAX_HEADING_LIMIT	(rad (180.0))
		#define LAUNCHER_PITCH_RATE		(rad (30.0))
		#define LAUNCHER_MIN_PITCH_LIMIT	(rad (15.0))
		#define LAUNCHER_MAX_PITCH_LIMIT	(rad (50.0))
