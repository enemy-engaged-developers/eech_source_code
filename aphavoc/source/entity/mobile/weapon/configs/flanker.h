...
// 
		...
		#define MID_HARDPOINT1	 			(0)
		#define MID_HARDPOINT2 	 			(1)
		#define LHS_HARDPOINT1	 			(3)
		#define RHS_HARDPOINT1 	 			(2)
		#define LHS_HARDPOINT2				(5)
		#define RHS_HARDPOINT2 				(4)
		#define LHS_HARDPOINT3				(7)
		#define RHS_HARDPOINT3 				(6)
		#define LHS_WING_TIP_MOUNT			(9)
		#define RHS_WING_TIP_MOUNT			(8)
		#define CANNON							(10)
		#define CHAFF_DISPENSER				(11)
		#define FLARE_DISPENSER				(11)

		#define CANNON_BARREL 				(0)
		#define ALAMO_PYLON					(0)
		#define KEDGE_PYLON 		 			(1)
		#define APHID_PYLON	 				(0)
		#define CHAFF_VECTOR				  	(0)
		#define FLARE_VECTOR				  	(0)

		#define NUM_CANNON_ROUNDS			(120)
		#define NUM_ALAMO_MISSILES			(1)
		#define NUM_KEDGE_MISSILES	 		(1)
		#define NUM_APHID_MISSILES			(1)
		...
		////////////////////////////////////////
		{
			...
			// WEAPON PACKAGE 6
			{
				ENTITY_SUB_TYPE_WEAPON_AA8B_APHID,	  					// sub_type
				NUM_APHID_MISSILES,	 				 						// number
		...
		#undef MID_HARDPOINT1
		#undef MID_HARDPOINT2
		...
		#undef NUM_KEDGE_MISSILES
		#undef NUM_APHID_MISSILES
		#undef NUM_CHAFFS
		#undef NUM_FLARES
