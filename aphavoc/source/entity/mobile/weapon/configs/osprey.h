...
// 
		...
		#define BTM_CHAFF_DISPENSER	(2)
		#define LHS_FLARE_DISPENSER	(0)
		#define RHS_FLARE_DISPENSER	(1)
		#define BTM_FLARE_DISPENSER	(2)
		...
		////////////////////////////////////////
		{
			...
			// WEAPON PACKAGE 3
			{
				ENTITY_SUB_TYPE_WEAPON_CHAFF,								// sub_type
				NUM_CHAFFS,	 	  												// number
				BTM_CHAFF_DISPENSER,											// heading_depth
				CHAFF_VECTOR,													// pitch_depth
				0,						  				 							// muzzle_depth
				FALSE,				  				 							// make_weapon_system_ready
				FALSE,															// rotate
			...
			// WEAPON PACKAGE 6
			{
				ENTITY_SUB_TYPE_WEAPON_FLARE,								// sub_type
				NUM_FLARES,	 													// number
				BTM_FLARE_DISPENSER,											// heading_depth
				FLARE_VECTOR,			  										// pitch_depth
				0,						  				 							// muzzle_depth
				FALSE,				  				 							// make_weapon_system_ready
				FALSE,															// rotate
		...
		#undef BTM_CHAFF_DISPENSER
		#undef LHS_FLARE_DISPENSER
		#undef RHS_FLARE_DISPENSER
		#undef BTM_FLARE_DISPENSER
