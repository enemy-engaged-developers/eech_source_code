...
// 
		...
		#define LHS_CHAFF_DISPENSER	(6)
		#define RHS_CHAFF_DISPENSER	(7)
		#define LHS_FLARE_DISPENSER	(6)
		#define RHS_FLARE_DISPENSER	(7)
		#define LHS2_FLARE_DISPENSER	(8)
		#define RHS2_FLARE_DISPENSER	(9)
