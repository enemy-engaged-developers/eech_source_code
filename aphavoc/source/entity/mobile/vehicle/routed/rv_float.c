...
static void set_local_float_value (entity *en, float_types type, float value)
{
	...
	{
		////////////////////////////////////////
		case FLOAT_TYPE_DESIRED_VELOCITY:
		////////////////////////////////////////
		{
			raw->desired_velocity = value;
...
void overload_routed_vehicle_float_value_functions (void)
{

	fn_set_local_entity_raw_float_value			[ENTITY_TYPE_ROUTED_VEHICLE][FLOAT_TYPE_DESIRED_VELOCITY]							= set_local_float_value;
	fn_set_local_entity_float_value				[ENTITY_TYPE_ROUTED_VEHICLE][FLOAT_TYPE_DESIRED_VELOCITY]							= set_local_float_value;
	fn_set_client_server_entity_float_value	[ENTITY_TYPE_ROUTED_VEHICLE][FLOAT_TYPE_DESIRED_VELOCITY][COMMS_MODEL_SERVER]	= set_server_float_value;
	fn_set_client_server_entity_float_value	[ENTITY_TYPE_ROUTED_VEHICLE][FLOAT_TYPE_DESIRED_VELOCITY][COMMS_MODEL_CLIENT]	= set_client_float_value;
	fn_get_local_entity_float_value				[ENTITY_TYPE_ROUTED_VEHICLE][FLOAT_TYPE_DESIRED_VELOCITY]							= get_local_float_value;
}
