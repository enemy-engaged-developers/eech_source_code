...
void overload_cargo_update_functions (void)
{
	fn_update_client_server_entity[ENTITY_TYPE_CARGO][COMMS_MODEL_SERVER]  	= update_server;

	fn_update_client_server_entity[ENTITY_TYPE_CARGO][COMMS_MODEL_CLIENT]  	= update_client;
}
