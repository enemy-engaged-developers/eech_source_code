...
static void set_local_vec3d (entity *en, vec3d_types type, vec3d *v)
{
	...
	{
		////////////////////////////////////////
		case VEC3D_TYPE_COVER_POSITION:
		////////////////////////////////////////
		{
			raw->cover_position = *v;

			break;
		}
		////////////////////////////////////////
		case VEC3D_TYPE_WAIT_POSITION:
		////////////////////////////////////////
		{
			raw->wait_position = *v;
...
void overload_helicopter_vec3d_functions (void)
{
	fn_set_local_entity_raw_vec3d			[ENTITY_TYPE_HELICOPTER][VEC3D_TYPE_COVER_POSITION]							= set_local_vec3d;
	fn_set_local_entity_vec3d				[ENTITY_TYPE_HELICOPTER][VEC3D_TYPE_COVER_POSITION]							= set_local_vec3d;
	fn_set_client_server_entity_vec3d	[ENTITY_TYPE_HELICOPTER][VEC3D_TYPE_COVER_POSITION][COMMS_MODEL_SERVER]	= set_server_vec3d;
	fn_set_client_server_entity_vec3d	[ENTITY_TYPE_HELICOPTER][VEC3D_TYPE_COVER_POSITION][COMMS_MODEL_CLIENT]	= set_client_vec3d;
	fn_get_local_entity_vec3d				[ENTITY_TYPE_HELICOPTER][VEC3D_TYPE_COVER_POSITION]						 	= get_local_vec3d;
	fn_get_local_entity_vec3d_ptr			[ENTITY_TYPE_HELICOPTER][VEC3D_TYPE_COVER_POSITION]							= get_local_vec3d_ptr;

	fn_set_local_entity_raw_vec3d			[ENTITY_TYPE_HELICOPTER][VEC3D_TYPE_WAIT_POSITION]								= set_local_vec3d;
	fn_set_local_entity_vec3d				[ENTITY_TYPE_HELICOPTER][VEC3D_TYPE_WAIT_POSITION]								= set_local_vec3d;
