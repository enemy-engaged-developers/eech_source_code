...
extern void set_full_screen_viewport (void);

extern void set_main_3d_params
(
...
extern void set_main_3d_inset_target_screen_params (void);

extern void set_crew_view_full_screen_params (void);

extern void draw_main_3d_scene (viewpoint *vp);
