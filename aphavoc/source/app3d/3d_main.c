...
{
	set_3d_viewport (main_3d_env, x, y, x + width, y + height);
	...
	set_3d_viewport (main_3d_single_light_env, x, y, x + width, y + height);
...
void set_pilots_full_screen_params (int night_vision_system_active)
{
	...
	{
		tint = (gunship_sides[get_global_gunship_type ()] != ENTITY_SIDE_RED_FORCE || !session_russian_nvg_no_ir) ? DISPLAY_3D_TINT_GREEN : DISPLAY_3D_TINT_GREEN_VISUAL;
