...
void deinitialise_parser (void)
{

	while ( campaign_while_loop_head )
	{
	...
	while ( campaign_event_head )
	{
		...
		if ( campaign_event_head->name )
			free ( campaign_event_head->name );
		if ( campaign_event_head->filename )
			free ( campaign_event_head->filename );
		free ( campaign_event_head );
		campaign_event_head = next;
	}
	...
	while ( campaign_trigger_head )
	{
		...
		if ( campaign_trigger_head->event_name )
			free ( campaign_trigger_head->event_name );
		free ( campaign_trigger_head );
		campaign_trigger_head = next;
	}
}
