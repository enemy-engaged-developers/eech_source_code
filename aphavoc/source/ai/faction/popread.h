...
extern int get_object_3d_troop_takeoff_route ( int object_index, vec3d **route );

extern int get_object_3d_troop_landing_position_and_heading ( int object_index, vec3d *position, float *heading );
