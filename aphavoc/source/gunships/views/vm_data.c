...
float
	...
	{
		rad (90.0f),		// VIEW_MODE_COCKPIT_PANEL_UP40_LEFT90
		rad (60.0f),		// VIEW_MODE_COCKPIT_PANEL_UP40_LEFT60
		rad (30.0f),		// VIEW_MODE_COCKPIT_PANEL_UP40_LEFT30
		rad (0.0),		// VIEW_MODE_COCKPIT_PANEL_UP40_AHEAD
		rad (-30.0f),	// VIEW_MODE_COCKPIT_PANEL_UP40_RIGHT30
		rad (-60.0f),	// VIEW_MODE_COCKPIT_PANEL_UP40_RIGHT60
		rad (-90.0f),	// VIEW_MODE_COCKPIT_PANEL_UP40_RIGHT90
		rad (90.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_LEFT90
		rad (60.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_LEFT60
		rad (30.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_LEFT30
		rad (0.0),		// VIEW_MODE_COCKPIT_PANEL_UP20_AHEAD
		rad (-30.0f),	// VIEW_MODE_COCKPIT_PANEL_UP20_RIGHT30
		rad (-60.0f),	// VIEW_MODE_COCKPIT_PANEL_UP20_RIGHT60
		rad (-90.0f),	// VIEW_MODE_COCKPIT_PANEL_UP20_RIGHT90
		rad (90.0f),		// VIEW_MODE_COCKPIT_PANEL_LEVEL_LEFT90
		rad (60.0f),		// VIEW_MODE_COCKPIT_PANEL_LEVEL_LEFT60
		rad (30.0f),		// VIEW_MODE_COCKPIT_PANEL_LEVEL_LEFT30
		rad (0.0),		// VIEW_MODE_COCKPIT_PANEL_LEVEL_AHEAD
		rad (-30.0f),	// VIEW_MODE_COCKPIT_PANEL_LEVEL_RIGHT30
		rad (-60.0f),	// VIEW_MODE_COCKPIT_PANEL_LEVEL_RIGHT60
		rad (-90.0f),	// VIEW_MODE_COCKPIT_PANEL_LEVEL_RIGHT90
		rad (90.0f),		// VIEW_MODE_COCKPIT_PANEL_DOWN20_LEFT90
		rad (60.0f),		// VIEW_MODE_COCKPIT_PANEL_DOWN20_LEFT60
		rad (30.0f),		// VIEW_MODE_COCKPIT_PANEL_DOWN20_LEFT30
		rad (0.0),		// VIEW_MODE_COCKPIT_PANEL_DOWN20_AHEAD
		rad (-30.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_RIGHT30
		rad (-60.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_RIGHT60
		rad (-90.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_RIGHT90
...
float
	pilot_head_pitch_values[NUM_VIEW_MODES] =
	{
		...
		rad (20.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_LEFT90
		rad (20.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_LEFT60
		rad (20.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_LEFT30
		rad (20.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_AHEAD
		rad (20.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_RIGHT30
		rad (20.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_RIGHT60
		rad (20.0f),		// VIEW_MODE_COCKPIT_PANEL_UP20_RIGHT90
		...
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_LEFT90
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_LEFT60
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_LEFT30
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_AHEAD
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_RIGHT30
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_RIGHT60
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_DOWN20_RIGHT90
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_SPECIAL_APACHE_LHS_MFD
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_SPECIAL_APACHE_RHS_MFD
		rad (-20.0f),	// VIEW_MODE_COCKPIT_PANEL_SPECIAL_HAVOC_TV
		rad (0.0),		// VIEW_MODE_COCKPIT_PANEL_SPECIAL_HAVOC_HUD
		rad (0.0),		// VIEW_MODE_VIRTUAL_COCKPIT
		rad (0.0),		// VIEW_MODE_VIRTUAL_COCKPIT_PADLOCK
		rad (0.0),		// VIEW_MODE_VIRTUAL_COCKPIT_TRACK_TARGET
