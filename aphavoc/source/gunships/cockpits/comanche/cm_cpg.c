...
void initialise_comanche_co_pilot_animation (void)
{
	#if DEBUG_MODULE
...
void deinitialise_comanche_co_pilot_animation (void)
{
}
...
void update_comanche_co_pilot_animation (void)
{
...
void set_comanche_co_pilot_head_position (void)
{
	int
		show_co_pilot_head;
...
float get_comanche_co_pilot_head_pitch_datum (void)
{
	float
		relative_pitch;
