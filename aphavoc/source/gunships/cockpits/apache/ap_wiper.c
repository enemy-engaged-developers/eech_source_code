...
static object_3d_instance
	*virtual_cockpit_wiper_inst3d = nullptr,
...
void deinitialise_apache_virtual_cockpit_wiper_and_rain_effect (void)
{
...
void draw_apache_virtual_cockpit_wiper (viewpoint *vp)
{
	float
		state;
...
void draw_apache_virtual_cockpit_rain_effect (viewpoint *vp)
{
	ASSERT (vp);
...
void animate_apache_external_wipers (object_3d_instance *inst3d)
{
	float
		state;
