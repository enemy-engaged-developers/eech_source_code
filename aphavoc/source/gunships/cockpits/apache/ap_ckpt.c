...
void initialise_apache_cockpits (void)
{
	initialise_apache_lamps ();

	initialise_apache_instrument_colours ();
}
...
void deinitialise_apache_cockpits (void)
{
}
...
void update_apache_cockpits (void)
{
}
...
void draw_apache_cockpit (cockpit_panels panel)
{
	////////////////////////////////////////
	//
	...
	switch (panel)
	{
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_apache_indicator_lamps (panel);

					draw_apache_fire_detector_lamps (panel);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				draw_apache_upfront_display_on_cockpit (fx_640_480 + 338.0, fy_640_480 + 428.0);
			}
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_apache_fixed_cockpit_clock_hands (panel);

					draw_apache_armament_lamps (panel);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_apache_fixed_cockpit_airspeed_indicator_needle (panel);

					draw_apache_fixed_cockpit_barometric_altimeter_digits (panel);

					draw_apache_fixed_cockpit_barometric_altimeter_needle (panel);
				...
				draw_apache_upfront_display_on_cockpit (fx_640_480 + 334.0, fy_640_480 + 226.0);

				draw_apache_mfd_on_cockpit (fx_640_480 + 226.0, fy_640_480 + 367.0, FALSE, FALSE, MFD_LOCATION_LHS);

				draw_apache_mfd_on_cockpit (fx_640_480 + 414.0, fy_640_480 + 367.0, FALSE, FALSE, MFD_LOCATION_RHS);
		...
		////////////////////////////////////////
		{
			...
			draw_apache_mfd_on_cockpit (fx_640_480 + 320.0, fy_640_480 + 235.0, TRUE, FALSE, MFD_LOCATION_LHS);
		...
		////////////////////////////////////////
		{
			...
			draw_apache_mfd_on_cockpit (fx_640_480 + 320.0, fy_640_480 + 235.0, TRUE, FALSE, MFD_LOCATION_RHS);
