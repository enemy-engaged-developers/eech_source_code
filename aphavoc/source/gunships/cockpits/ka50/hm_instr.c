...
void initialise_ka50_instrument_colours (void)
{
...
void set_ka50_instrument_colours (void)
{
...
void draw_ka50_barometric_altimeter (cockpit_panels panel)
{
	float
		large_needle_value,
		small_needle_value,
...
void draw_ka50_airspeed_indicator (cockpit_panels panel)
{
	float
...
void draw_ka50_main_rotor_rpm_indicator (cockpit_panels panel)
{
	float
...
void draw_ka50_g_meter (cockpit_panels panel)
{
	float
...
void draw_ka50_engine_torque_indicator (cockpit_panels panel)
{
	float
...
void draw_ka50_engine_temperature_indicator (cockpit_panels panel)
{
	float
...
void draw_ka50_engine_rpm_indicator (cockpit_panels panel)
{
	float
...
void draw_ka50_engine_temperature_and_rpm_indicator_ticks (cockpit_panels panel)
{
...
void draw_ka50_vertical_speed_indicator (cockpit_panels panel)
{
	float
...
void draw_ka50_clock (cockpit_panels panel)
{
	float
		time_of_day,
		hour_hand_value,
...
void draw_ka50_radar_altimeter (cockpit_panels panel)
{
	float
...
void draw_ka50_fuel_gauge (cockpit_panels panel)
{
	float
...
void draw_ka50_fixed_cockpit_hsi_waypoint_distance_digits (cockpit_panels panel)
{
	float
	...
	if ((wp) && (!ka50_damage.navigation_computer))
	{
		en_position = get_local_entity_vec3d_ptr (en, VEC3D_TYPE_POSITION);
...
void draw_ka50_fixed_cockpit_hsi_waypoint_identifier (cockpit_panels panel)
{
	entity
		*wp;
...
void get_ka50_virtual_cockpit_adi_angles (matrix3x3 attitude, float *heading, float *pitch, float *roll)
{
	matrix3x3
		inverse_attitude,
		heading_rotation,
