...
void initialise_ka50_pilot_animation (void)
{
	#if DEBUG_MODULE
...
void deinitialise_ka50_pilot_animation (void)
{
...
void update_ka50_pilot_animation (void)
{
...
void set_ka50_pilot_head_position (void)
{
	int
		show_pilot_head;
...
float get_ka50_pilot_head_pitch_datum (void)
{
	float
		relative_pitch;
...
void reset_ka50_pilot_eject_sequence (void)
{
	eject_timer = 0.0;
