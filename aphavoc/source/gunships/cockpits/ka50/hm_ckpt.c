...
void initialise_ka50_cockpits (void)
{
	...
	initialise_ka50_instrument_colours ();
}
...
void draw_ka50_cockpit (cockpit_panels panel)
{
	////////////////////////////////////////
	//
	...
	switch (panel)
	{
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_ka50_g_meter (panel);

					draw_ka50_radar_altimeter (panel);

					draw_ka50_weapons_management_panel_lamps (panel);

					draw_ka50_master_caution_lamp (panel);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_ka50_threat_warning_display (panel);

					draw_ka50_master_caution_lamp (panel);

					draw_ka50_warning_panel_lamps (panel);

					unlock_screen (active_screen);
				}

				draw_ka50_internal_virtual_cockpit (VIRTUAL_COCKPIT_HUD_GLASS);

				draw_ka50_hud_on_cockpit (get_global_hud_enlarge ());
			}
			else
			{
				draw_ka50_hud_on_cockpit (TRUE);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_ka50_status_panel_lamps (panel);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_ka50_barometric_altimeter (panel);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_ka50_airspeed_indicator (panel);

					draw_ka50_main_rotor_rpm_indicator (panel);

					draw_ka50_g_meter (panel);

					draw_ka50_vertical_speed_indicator (panel);

					draw_ka50_clock (panel);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_ka50_engine_torque_indicator (panel);

					draw_ka50_engine_temperature_indicator (panel);

					draw_ka50_engine_rpm_indicator (panel);

					draw_ka50_engine_temperature_and_rpm_indicator_ticks (panel);
					...
					draw_ka50_fuel_gauge (panel);

					draw_ka50_fixed_cockpit_hsi_waypoint_distance_digits (panel);

					draw_ka50_fixed_cockpit_hsi_waypoint_identifier (panel);
					...
					draw_ka50_radio_lamp (panel);

					draw_ka50_oil_gauges (panel);
				...
				draw_ka50_mfd_on_cockpit (fx_640_480 + 354.0, fy_640_480 + 337.0, FALSE, FALSE);

				draw_ka50_ekran_display_on_cockpit (fx_640_480 + 459.0, fy_640_480 + 310.0);
		...
		////////////////////////////////////////
		{
			...
			draw_ka50_mfd_on_cockpit (fx_640_480 + 321.0, fy_640_480 + 229.0, TRUE, FALSE);
