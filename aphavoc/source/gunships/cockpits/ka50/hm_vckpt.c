...
static int ka50_periscope_box_check ( void )	// Retro 6Feb2005 (whole block)
{
...
int ka50_periscope_check ( int currentlyUsingPeriscope )	// Retro 6Feb2005 (whole block)
{
	...
	return ka50_periscope_box_check ();
}
#endif
