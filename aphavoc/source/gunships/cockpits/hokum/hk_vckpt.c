...
//VJ 050131 update on wideview mod, much better movement
		...
		mfd_light_power = (float)(get_hokum_mfd_mode(HOKUM_MFD_LOCATION_PILOT_LHS) % NUM_HOKUM_MFD_LOCATIONS + !!get_hokum_mfd_mode(HOKUM_MFD_LOCATION_PILOT_LHS) + 
					get_hokum_mfd_mode(HOKUM_MFD_LOCATION_PILOT_RHS) % NUM_HOKUM_MFD_LOCATIONS + !!get_hokum_mfd_mode(HOKUM_MFD_LOCATION_PILOT_RHS) + 
					get_hokum_mfd_mode(HOKUM_MFD_LOCATION_CO_PILOT_LHS) % NUM_HOKUM_MFD_LOCATIONS + !!get_hokum_mfd_mode(HOKUM_MFD_LOCATION_CO_PILOT_LHS) + 
					get_hokum_mfd_mode(HOKUM_MFD_LOCATION_CO_PILOT_RHS) % NUM_HOKUM_MFD_LOCATIONS + !!get_hokum_mfd_mode(HOKUM_MFD_LOCATION_CO_PILOT_RHS))
					/ (float)(NUM_HOKUM_MFD_LOCATIONS * NUM_HOKUM_MFD_LOCATIONS);
