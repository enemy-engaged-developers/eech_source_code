...
#define PILOT_PEDAL_ANIM_START												((float) (0.0 / LAST_FRAME))
#define PILOT_PEDAL_ANIM_END													((float) (60.0 / LAST_FRAME))

#define PILOT_LEG_ANIM_START													((float) (0.0 / LAST_FRAME))
#define PILOT_LEG_ANIM_END														((float) (60.0 / LAST_FRAME))

#define PILOT_HEAD_TILT_RIGHT_ANIM_START									((float) (0.0 / LAST_FRAME))
#define PILOT_HEAD_TILT_RIGHT_ANIM_END										((float) (15.0 / LAST_FRAME))

#define PILOT_HEAD_TILT_LEFT_ANIM_START									((float) (30.0 / LAST_FRAME))
#define PILOT_HEAD_TILT_LEFT_ANIM_END										((float) (45.0 / LAST_FRAME))

// 60.0 to 120.0 - no frames

#define PILOT_CONTROLS_TO_REST_ANIM_START									((float) (120.0 / LAST_FRAME))
#define PILOT_CONTROLS_TO_REST_ANIM_END									((float) (180.0 / LAST_FRAME))

#define PILOT_RIGHT_HAND_FROM_REST_TO_UPPER_SWITCH_ANIM_START		((float) (180.0 / LAST_FRAME))
#define PILOT_RIGHT_HAND_FROM_REST_TO_UPPER_SWITCH_ANIM_END			((float) (300.0 / LAST_FRAME))

#define PILOT_RIGHT_HAND_FROM_REST_TO_CALCULATOR_ANIM_START			((float) (300.0 / LAST_FRAME))
#define PILOT_RIGHT_HAND_FROM_REST_TO_CALCULATOR_ANIM_END			((float) (420.0 / LAST_FRAME))

#define PILOT_LEFT_HAND_FROM_REST_TO_HUD_SWITCH_ANIM_START			((float) (420.0 / LAST_FRAME))
#define PILOT_LEFT_HAND_FROM_REST_TO_HUD_SWITCH_ANIM_END				((float) (540.0 / LAST_FRAME))

#define PILOT_LEFT_HAND_FROM_REST_TO_NVG_ANIM_START					((float) (540.0 / LAST_FRAME))
#define PILOT_LEFT_HAND_FROM_REST_TO_NVG_ANIM_END						((float) (660.0 / LAST_FRAME))

#define PILOT_BOTH_HANDS_FROM_REST_TO_PULL_EJECT_ANIM_START			((float) (660.0 / LAST_FRAME))
#define PILOT_BOTH_HANDS_FROM_REST_TO_PULL_EJECT_ANIM_END			((float) (750.0 / LAST_FRAME))

// 750.0 to 780.0 - no frames

#define PILOT_BOTH_HANDS_FROM_CONTROLS_TO_PULL_EJECT_ANIM_START	((float) (780.0 / LAST_FRAME))
#define PILOT_BOTH_HANDS_FROM_CONTROLS_TO_PULL_EJECT_ANIM_END		((float) (870.0 / LAST_FRAME))

// 870.0 to 900.0 - no frames

#define PILOT_LEFT_HAND_FROM_COLLECTIVE_TO_NVG_ANIM_START			((float) (900.0 / LAST_FRAME))
#define PILOT_LEFT_HAND_FROM_COLLECTIVE_TO_NVG_ANIM_END				((float) (1020.0 / LAST_FRAME))
...
enum PILOT_MAIN_ANIM_MODES
{
	...
	PILOT_MAIN_ANIM_MODE_LEFT_HAND_TO_NVG,
	PILOT_MAIN_ANIM_MODE_COLLECTIVE_TO_CENTRE1,
	PILOT_MAIN_ANIM_MODE_COLLECTIVE_TO_CENTRE2,
	PILOT_MAIN_ANIM_MODE_COLLECTIVE_FROM_CENTRE1,
	PILOT_MAIN_ANIM_MODE_COLLECTIVE_FROM_CENTRE2,
...
static pilot_anim_data
	pilot_main_anim_mode_left_hand_to_nvg_anim_data =
	{
		PILOT_LEFT_HAND_FROM_COLLECTIVE_TO_NVG_ANIM_START,						// start_frame
		PILOT_LEFT_HAND_FROM_COLLECTIVE_TO_NVG_ANIM_END,						// end_frame
		0.0,																					// cyclic_x_position
		0.0,																					// cyclic_y_position
		0.5,																					// collective_position
		0.0,																					// pedal_position
...
static pilot_anim_data
	pilot_main_anim_mode_collective_to_centre1_anim_data =
	{
		0.0,																					// start_frame
		0.0,																					// end_frame
		0.0,																					// cyclic_x_position
...
static pilot_anim_data
	pilot_main_anim_mode_collective_to_centre2_anim_data =
	{
		0.0,																					// start_frame
		0.0,																					// end_frame
		0.0,																					// cyclic_x_position
...
static pilot_anim_data
	pilot_main_anim_mode_collective_from_centre1_anim_data =
	{
		0.0,																					// start_frame
		0.0,																					// end_frame
		0.0,																					// cyclic_x_position
...
static pilot_anim_data
	pilot_main_anim_mode_collective_from_centre2_anim_data =
	{
		0.0,																					// start_frame
		0.0,																					// end_frame
		0.0,																					// cyclic_x_position
...
enum PILOT_REST_ANIM_MODES
{
	...
	PILOT_REST_ANIM_MODE_RIGHT_HAND_TO_UPPER_SWITCH,
	PILOT_REST_ANIM_MODE_RIGHT_HAND_TO_CALCULATOR,
	PILOT_REST_ANIM_MODE_LEFT_HAND_TO_HUD_SWITCH,
	PILOT_REST_ANIM_MODE_LEFT_HAND_TO_NVG,
	PILOT_REST_ANIM_MODE_BOTH_HANDS_PULL_EJECT,
...
static pilot_anim_data
	pilot_rest_anim_mode_right_hand_to_upper_switch_anim_data =
	{
		PILOT_RIGHT_HAND_FROM_REST_TO_UPPER_SWITCH_ANIM_START,				// start_frame
		PILOT_RIGHT_HAND_FROM_REST_TO_UPPER_SWITCH_ANIM_END,					// end_frame
		0.5,																					// cyclic_x_position
		0.5,																					// cyclic_y_position
		0.5,																					// collective_position
		0.5,																					// pedal_position
...
static pilot_anim_data
	pilot_rest_anim_mode_left_hand_to_hud_switch_anim_data =
	{
		PILOT_LEFT_HAND_FROM_REST_TO_HUD_SWITCH_ANIM_START,					// start_frame
		PILOT_LEFT_HAND_FROM_REST_TO_HUD_SWITCH_ANIM_END,						// end_frame
		0.5,																					// cyclic_x_position
		0.5,																					// cyclic_y_position
		0.5,																					// collective_position
		0.5,																					// pedal_position
...
static pilot_anim_data
	pilot_rest_anim_mode_left_hand_to_nvg_anim_data =
	{
		PILOT_LEFT_HAND_FROM_REST_TO_NVG_ANIM_START,								// start_frame
		PILOT_LEFT_HAND_FROM_REST_TO_NVG_ANIM_END,								// end_frame
		0.5,																					// cyclic_x_position
		0.5,																					// cyclic_y_position
		0.5,																					// collective_position
		0.5,																					// pedal_position
...
static pilot_anim_data
	pilot_rest_anim_mode_both_hands_pull_eject_anim_data =
	{
		PILOT_BOTH_HANDS_FROM_REST_TO_PULL_EJECT_ANIM_START,					// start_frame
		PILOT_BOTH_HANDS_FROM_REST_TO_PULL_EJECT_ANIM_END,						// end_frame
		0.5,																					// cyclic_x_position
		0.5,																					// cyclic_y_position
		0.5,																					// collective_position
		0.5,																					// pedal_position
...
{
	read_motion_values ("GRAPHICS\\COCKPITS\\HOKUM\\JOYSTICK.MOT", NUM_RIGHT_ARM_FRAMES, right_arm_joystick_motion);

	read_motion_values ("GRAPHICS\\COCKPITS\\HOKUM\\FOREARM.MOT", NUM_RIGHT_ARM_FRAMES, right_arm_forearm_motion);

	read_motion_values ("GRAPHICS\\COCKPITS\\HOKUM\\SHOULDER.MOT", NUM_RIGHT_ARM_FRAMES, right_arm_shoulder_motion);
}
...
static void set_pilot_static_right_hand_on_cyclic_visibility (int visible)
{
	...
	{
		search_data.result_sub_object->visible_object = !visible && !(get_global_wide_cockpit () && wide_cockpit_nr == WIDEVIEW_HOKUM_PILOT);
	}
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//
// ANIMATE PILOT'S LEGS AND PEDALS
//

...
static void set_pilot_legs_and_pedal_position (float pedal)
{
	...
	anim_frame *= PILOT_PEDAL_ANIM_END - PILOT_PEDAL_ANIM_START;

	anim_frame += PILOT_PEDAL_ANIM_START;

	anim_frame = bound (anim_frame, PILOT_PEDAL_ANIM_START, PILOT_PEDAL_ANIM_END);

	animate_entity_simple_keyframed_sub_objects (virtual_cockpit_inst3d, OBJECT_3D_SUB_OBJECT_COCKPIT_PILOT_PEDAL, anim_frame);
...
static void set_pilot_pedal_position (float pedal)
{
	float
		anim_frame;
...
static void set_pilot_animation (pilot_anim_data *anim, float frame, int set_head_anim_only)
{
	...
	{
		set_pilot_pedal_position (anim->pedal_position);
	}
	...
	{
		animate_entity_simple_keyframed_sub_objects (virtual_cockpit_inst3d, OBJECT_3D_SUB_OBJECT_COCKPIT_PILOT_EJECT_HANDLE, anim_frame);
	}
	else
	{
		animate_entity_simple_keyframed_sub_objects (virtual_cockpit_inst3d, OBJECT_3D_SUB_OBJECT_COCKPIT_PILOT_EJECT_HANDLE, PILOT_ANIM_DEFAULT);
	}
	...
	{
		nvg_anim_frame = ((PILOT_LEFT_HAND_FROM_REST_TO_NVG_ANIM_END - PILOT_LEFT_HAND_FROM_REST_TO_NVG_ANIM_START) * pilot_nvg_anim_frame) + PILOT_LEFT_HAND_FROM_REST_TO_NVG_ANIM_START;

		nvg_anim_frame = bound (nvg_anim_frame, PILOT_LEFT_HAND_FROM_REST_TO_NVG_ANIM_START, PILOT_LEFT_HAND_FROM_REST_TO_NVG_ANIM_END);
	}
	else
	{
		nvg_anim_frame = ((PILOT_LEFT_HAND_FROM_COLLECTIVE_TO_NVG_ANIM_END - PILOT_LEFT_HAND_FROM_COLLECTIVE_TO_NVG_ANIM_START) * pilot_nvg_anim_frame) + PILOT_LEFT_HAND_FROM_COLLECTIVE_TO_NVG_ANIM_START;

		nvg_anim_frame = bound (nvg_anim_frame, PILOT_LEFT_HAND_FROM_COLLECTIVE_TO_NVG_ANIM_START, PILOT_LEFT_HAND_FROM_COLLECTIVE_TO_NVG_ANIM_END);
	}

	animate_entity_simple_keyframed_sub_objects (virtual_cockpit_inst3d, OBJECT_3D_SUB_OBJECT_PILOT_NVG, nvg_anim_frame);
...
static int get_pilot_main_anim_mode_nvg_animation (void)
{
	switch (pilot_main_anim_mode)
	{
		case PILOT_MAIN_ANIM_MODE_LEFT_HAND_TO_NVG:
		case PILOT_MAIN_ANIM_MODE_COLLECTIVE_TO_CENTRE1:
		case PILOT_MAIN_ANIM_MODE_COLLECTIVE_TO_CENTRE2:
		case PILOT_MAIN_ANIM_MODE_COLLECTIVE_FROM_CENTRE1:
		case PILOT_MAIN_ANIM_MODE_COLLECTIVE_FROM_CENTRE2:
		{
			return (TRUE);
...
static int get_pilot_rest_anim_mode_body_animation (void)
{
	...
	{
		case PILOT_REST_ANIM_MODE_RIGHT_HAND_TO_UPPER_SWITCH:
		case PILOT_REST_ANIM_MODE_RIGHT_HAND_TO_CALCULATOR:
		case PILOT_REST_ANIM_MODE_LEFT_HAND_TO_HUD_SWITCH:
		case PILOT_REST_ANIM_MODE_LEFT_HAND_TO_NVG:
		case PILOT_REST_ANIM_MODE_BOTH_HANDS_PULL_EJECT:
		{
			return (TRUE);
...
static pilot_rest_anim_modes get_random_pilot_rest_anim_mode (void)
{
	...
	else
	{
		...
		//
		// the pilot cannot move his head while operating the night vision goggles
		//

		if (get_pilot_main_anim_mode_nvg_animation ())
		{
			return (PILOT_REST_ANIM_MODE_NONE);
		}
	...
	if (mode == PILOT_REST_ANIM_MODE_NONE)
	{
		switch (n)
		{
			case 0:
			{
				mode = PILOT_REST_ANIM_MODE_RIGHT_HAND_TO_UPPER_SWITCH;
			...
			case 2:
			{
				mode = PILOT_REST_ANIM_MODE_LEFT_HAND_TO_HUD_SWITCH;
...
static void update_pilot_rest_animation (int head_anim_only)
{
	...
	if (get_pilot_viewpoint_virtual_cockpit ())
	{
		...
		{
			pilot_nvg_anim_frame = NVG_ON;
		}
		else
		{
			pilot_nvg_anim_frame = NVG_OFF;
		}
	}
	...
	switch (pilot_rest_anim_mode)
	{
		...
		////////////////////////////////////////
		{
			...
			anim_data = &pilot_rest_anim_mode_right_hand_to_upper_switch_anim_data;
		...
		////////////////////////////////////////
		{
			...
			anim_data = &pilot_rest_anim_mode_left_hand_to_hud_switch_anim_data;

			pilot_rest_anim_frame += get_delta_time () * 0.333;
		...
		////////////////////////////////////////
		{
			...
			anim_data = &pilot_rest_anim_mode_left_hand_to_nvg_anim_data;

			if (night_vision_system_active)
			{
				pilot_nvg_anim_frame += get_delta_time () * 0.5;

				if (pilot_nvg_anim_frame >= NVG_ON)
				{
					pilot_nvg_anim_frame = NVG_ON;
			...
			else
			{
				...
				if (pilot_nvg_anim_frame <= NVG_OFF)
				{
					pilot_nvg_anim_frame = NVG_OFF;
			...
			pilot_rest_anim_frame = pilot_nvg_anim_frame;
		...
		////////////////////////////////////////
		{
			...
			anim_data = &pilot_rest_anim_mode_both_hands_pull_eject_anim_data;

			pilot_rest_anim_frame += get_delta_time ();

			if (pilot_rest_anim_frame >= 1.0)
			{
				//
				// (hold pilot anim at last frame until camera is outside)
				//
...
static void update_pilot_hands_off_controls (void)
{
	...
	{
		if (pilot_rest_anim_mode != PILOT_REST_ANIM_MODE_LEFT_HAND_TO_NVG)
		{
			if
			(
				(night_vision_system_active && (pilot_nvg_anim_frame == NVG_OFF)) ||
				(!night_vision_system_active && (pilot_nvg_anim_frame == NVG_ON))
			)
			{
				...
				{
					pilot_rest_anim_mode = PILOT_REST_ANIM_MODE_LEFT_HAND_TO_NVG;
...
static void update_pilot_hands_on_controls (void)
{
	...
	)
	{
		if (!get_pilot_viewpoint_virtual_cockpit ())
		{
			...
			{
				pilot_main_anim_mode = PILOT_MAIN_ANIM_MODE_COLLECTIVE_TO_CENTRE1;

				update_pilot_collective_to_centre1 ();
...
static void update_pilot_left_hand_to_nvg (void)
{
	...
	anim_data = &pilot_main_anim_mode_left_hand_to_nvg_anim_data;
	...
	if (night_vision_system_active)
	{
		...
		if (pilot_nvg_anim_frame >= NVG_ON)
		{
			...
			pilot_main_anim_mode = PILOT_MAIN_ANIM_MODE_COLLECTIVE_FROM_CENTRE1;

			update_pilot_collective_from_centre1 ();
	...
	pilot_main_anim_frame = pilot_nvg_anim_frame;
...
static void update_pilot_collective_to_centre1 (void)
{
	...
	anim_data = &pilot_main_anim_mode_collective_to_centre1_anim_data;
	...
	pilot_main_anim_mode = PILOT_MAIN_ANIM_MODE_COLLECTIVE_TO_CENTRE2;
}
...
static void update_pilot_collective_to_centre2 (void)
{
	...
	anim_data = &pilot_main_anim_mode_collective_to_centre2_anim_data;
	...
	pilot_main_anim_mode = PILOT_MAIN_ANIM_MODE_LEFT_HAND_TO_NVG;
}
...
static void update_pilot_collective_from_centre1 (void)
{
	...
	anim_data = &pilot_main_anim_mode_collective_from_centre1_anim_data;
	...
	pilot_main_anim_mode = PILOT_MAIN_ANIM_MODE_COLLECTIVE_FROM_CENTRE2;
}
...
static void update_pilot_collective_from_centre2 (void)
{
	...
	anim_data = &pilot_main_anim_mode_collective_from_centre2_anim_data;
...
static void update_pilot_animation (void)
{
	...
	if (get_local_entity_int_value (get_gunship_entity (), INT_TYPE_EJECTED))
	{
		if (get_crew_role () == CREW_ROLE_PILOT)
		{
			if ((pilot_rest_anim_mode != PILOT_REST_ANIM_MODE_BOTH_HANDS_PULL_EJECT) && (eject_stage == 0))
			{
				//
				// set main anim
				//
				...
				pilot_rest_anim_mode = PILOT_REST_ANIM_MODE_BOTH_HANDS_PULL_EJECT;
	...
	switch (pilot_main_anim_mode)
	{
		...
		////////////////////////////////////////
		{
			update_pilot_collective_to_centre2 ();
		...
		////////////////////////////////////////
		{
			update_pilot_collective_from_centre2 ();
...
static void update_pilot_head_tilt_animation (void)
{
	...
	if (pilot_head_tilt_angle >= 0.0)
	{
		frame = pilot_head_tilt_angle * (1.0 / MAX_ROLL);

		anim_frame = ((PILOT_HEAD_TILT_RIGHT_ANIM_END - PILOT_HEAD_TILT_RIGHT_ANIM_START) * frame) + PILOT_HEAD_TILT_RIGHT_ANIM_START;

		anim_frame = bound (anim_frame, PILOT_HEAD_TILT_RIGHT_ANIM_START, PILOT_HEAD_TILT_RIGHT_ANIM_END);
	}
	else
	{
		frame = -pilot_head_tilt_angle * (1.0 / MAX_ROLL);

		anim_frame = ((PILOT_HEAD_TILT_LEFT_ANIM_END - PILOT_HEAD_TILT_LEFT_ANIM_START) * frame) + PILOT_HEAD_TILT_LEFT_ANIM_START;

		anim_frame = bound (anim_frame, PILOT_HEAD_TILT_LEFT_ANIM_START, PILOT_HEAD_TILT_LEFT_ANIM_END);
	}
...
void initialise_hokum_pilot_animation (void)
{
	#if DEBUG_MODULE
	...
	debug_colour_watch (COLOUR_AMBER, "pilot_nvg_anim_frame = %.2f", MT_FLOAT, &pilot_nvg_anim_frame);
...
void deinitialise_hokum_pilot_animation (void)
{
...
void update_hokum_pilot_animation (void)
{
...
void set_hokum_pilot_head_position (void)
{
	int
		show_pilot_head;
...
float get_hokum_pilot_head_pitch_datum (void)
{
	float
		relative_pitch;
...
void reset_hokum_pilot_eject_sequence (void)
{
	eject_timer = 0.0;
