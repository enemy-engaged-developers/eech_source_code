...
void initialise_blackhawk_cockpits (void)
{
	...
	initialise_blackhawk_instrument_colours ();
}
...
void draw_blackhawk_cockpit (cockpit_panels panel)
{
	////////////////////////////////////////
	//
	...
	set_blackhawk_instrument_colours ();
	...
	switch (panel)
	{
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_blackhawk_indicator_lamps (panel);

					draw_blackhawk_fire_detector_lamps (panel);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				draw_blackhawk_upfront_display_on_cockpit (fx_640_480 + 338.0, fy_640_480 + 428.0);
			}
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_blackhawk_fixed_cockpit_clock_hands (panel);

					draw_blackhawk_armament_lamps (panel);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_blackhawk_mfd_lamps (panel);
		...
		////////////////////////////////////////
		{
			if (get_global_draw_cockpit_graphics ())
			{
				...
				if (lock_screen (active_screen))
				{
					...
					draw_blackhawk_fixed_cockpit_airspeed_indicator_needle (panel);

					draw_blackhawk_fixed_cockpit_barometric_altimeter_digits (panel);

					draw_blackhawk_fixed_cockpit_barometric_altimeter_needle (panel);
				...
				draw_blackhawk_upfront_display_on_cockpit (fx_640_480 + 334.0, fy_640_480 + 226.0);

				draw_blackhawk_mfd_on_cockpit (fx_640_480 + 226.0, fy_640_480 + 367.0, FALSE, FALSE, MFD_LOCATION_LHS);

				draw_blackhawk_mfd_on_cockpit (fx_640_480 + 414.0, fy_640_480 + 367.0, FALSE, FALSE, MFD_LOCATION_RHS);
		...
		////////////////////////////////////////
		{
			...
			draw_blackhawk_mfd_on_cockpit (fx_640_480 + 320.0, fy_640_480 + 235.0, TRUE, FALSE, MFD_LOCATION_LHS);
		...
		////////////////////////////////////////
		{
			...
			draw_blackhawk_mfd_on_cockpit (fx_640_480 + 320.0, fy_640_480 + 235.0, TRUE, FALSE, MFD_LOCATION_RHS);
