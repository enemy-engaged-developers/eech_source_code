...
void initialise_ah64a_cockpits (void)
{
	initialise_ah64a_lamps ();

	initialise_ah64a_instrument_colours ();
}
...
void deinitialise_ah64a_cockpits (void)
{
}
...
void update_ah64a_cockpits (void)
{
}
