...
void initialise_ah64a_virtual_cockpit_wiper_and_rain_effect (void)
{
...
void deinitialise_ah64a_virtual_cockpit_wiper_and_rain_effect (void)
{
...
void draw_ah64a_virtual_cockpit_wiper (viewpoint *vp)
{
	float
		state;
...
void draw_ah64a_virtual_cockpit_rain_effect (viewpoint *vp)
{
	ASSERT (vp);
...
void animate_ah64a_external_wipers (object_3d_instance *inst3d)
{
	float
		state;
