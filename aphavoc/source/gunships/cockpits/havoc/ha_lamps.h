...
typedef struct HAVOC_LAMP_FLAGS havoc_lamp_flags;
...
extern void initialise_havoc_lamps (void);

extern void draw_havoc_weapons_management_panel_lamps (cockpit_panels panel);

extern void draw_havoc_status_panel_lamps (cockpit_panels panel);

extern void draw_havoc_threat_warning_display (cockpit_panels panel);

extern void draw_havoc_master_caution_lamp (cockpit_panels panel);

extern void draw_havoc_warning_panel_lamps (cockpit_panels panel);

extern void draw_havoc_radio_lamp (cockpit_panels panel);

extern void draw_havoc_oil_gauges (cockpit_panels panel);

extern void draw_overlaid_threat_warning_display (int x_org, int y_org);
