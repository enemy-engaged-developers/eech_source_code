...
void initialise_default_virtual_cockpit (void)
{
	//
	// 3D instances
	//
...
void deinitialise_default_virtual_cockpit (void)
{
	//
	// 3D instances
	//
	...
	deinitialise_default_virtual_cockpit_wiper_and_rain_effect ();
...
void update_default_virtual_cockpit (void)
{
}
...
void draw_default_internal_virtual_cockpit (unsigned int flags)
{
...
//VJ 050108 wideview x coord used to clip default cockpit
		if (get_global_wide_cockpit ())
...
//VJ wideview mod, date: 18-mar-03, 050123
	...
	(
		...
		//(get_default_tads_display_visible ()) &&
...
void draw_default_external_virtual_cockpit (unsigned int flags, unsigned char *wiper_rle_graphic)
{
	viewpoint
		vp;
...
void damage_default_virtual_cockpit_main_rotors (int seed)
{
	float
		theta;
...
void restore_default_virtual_cockpit_main_rotors (void)
{
	float
		theta;
