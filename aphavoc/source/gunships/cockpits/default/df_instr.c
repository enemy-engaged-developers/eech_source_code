...
void set_default_instrument_colours (void)
{
...
void draw_default_fixed_cockpit_airspeed_indicator_needle (cockpit_panels panel)
{
	float
		airspeed_needle_value,
		x_centre,
...
void draw_default_fixed_cockpit_barometric_altimeter_digits (cockpit_panels panel)
{
	float
		altimeter_digital_value,
		x,
...
float get_default_virtual_cockpit_adi_slip_indicator_needle_value (void)
{
	float
		slip_needle_value;
...
float get_default_virtual_cockpit_airspeed_indicator_needle_value (void)
{
	float
		airspeed_needle_value,
		fraction,
...
float get_default_virtual_cockpit_barometric_altimeter_needle_value (void)
{
	float
		altimeter_needle_value;
...
void get_default_virtual_cockpit_clock_hand_values (float *hours, float *minutes, float *seconds)
{
	float
		hour_hand_value,
		minute_hand_value,
