...
void initialise_hind_virtual_cockpit_wiper_and_rain_effect (void)
{
...
void deinitialise_hind_virtual_cockpit_wiper_and_rain_effect (void)
{
...
void draw_hind_virtual_cockpit_wiper (viewpoint *vp, int large_hud)
{
	object_3d_instance
		*wiper_arm_inst3d,
		*wiper_rod_inst3d;
...
void draw_hind_virtual_cockpit_rain_effect (viewpoint *vp, int large_hud)
{
	ASSERT (vp);
...
void animate_hind_external_wipers (object_3d_instance *inst3d)
{
	object_3d_sub_object_search_data
		search;
