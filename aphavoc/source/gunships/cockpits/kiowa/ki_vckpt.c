...
void draw_kiowa_virtual_cockpit (void)
{
	...
	if (begin_3d_scene ())
	{
		...
		mfd_light_power = (float)(get_kiowa_main_mfd_mode(KIOWA_MAIN_MFD_LOCATION_CO_PILOT) % NUM_KIOWA_MAIN_MFD_LOCATIONS + !!get_kiowa_main_mfd_mode(KIOWA_MAIN_MFD_LOCATION_CO_PILOT) +
					get_kiowa_main_mfd_mode(KIOWA_MAIN_MFD_LOCATION_PILOT) % NUM_KIOWA_MAIN_MFD_LOCATIONS + !!get_kiowa_main_mfd_mode(KIOWA_MAIN_MFD_LOCATION_PILOT) + 
					get_kiowa_main_mfd_mode(KIOWA_MAIN_MFD_LOCATION_CENTER) % NUM_KIOWA_MAIN_MFD_LOCATIONS + !!get_kiowa_main_mfd_mode(KIOWA_MAIN_MFD_LOCATION_CENTER))
					/ (float)(NUM_KIOWA_MAIN_MFD_LOCATIONS * NUM_KIOWA_MAIN_MFD_LOCATIONS);
