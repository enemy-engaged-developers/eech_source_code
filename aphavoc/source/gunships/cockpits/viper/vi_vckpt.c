...
void damage_viper_virtual_cockpit_main_rotors (int seed)
{
	float
		theta;
	...
	damage_helicopter_main_rotor_inst3d (virtual_cockpit_inst3d_detail_level_normal_inst3d, seed);
...
void restore_viper_virtual_cockpit_main_rotors (void)
{
	float
		theta;
