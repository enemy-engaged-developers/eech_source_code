...
void initialise_viper_pilot_animation (void)
{
	#if DEBUG_MODULE
...
void deinitialise_viper_pilot_animation (void)
{
...
void update_viper_pilot_animation (void)
{
...
void set_viper_pilot_head_position (void)
{
	int
		show_pilot_head;
...
float get_viper_pilot_head_pitch_datum (void)
{
	float
		relative_pitch;
