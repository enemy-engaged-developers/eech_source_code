...
{
	centre_apache_target_acquisition_system ();
}
...
{
	toggle_apache_show_allied_targets ();
}
...
{
	apache_target_acquisition_system_misc_function1 ();
}
...
{
	apache_target_acquisition_system_misc_function2 ();
}
...
{
	select_next_apache_tsd_ase_range ();
}
...
{
	select_previous_apache_tsd_ase_range ();
}
...
{
	select_next_apache_tsd_declutter_level ();
}
...
{
	select_previous_apache_lhs_mfd ();
}
...
{
	select_previous_apache_rhs_mfd ();
}
...
{
	toggle_apache_infra_red_jammer_manual ();
}
...
void set_apache_avionics_events (void)
{
