...
float
	apache_stinger_seeker_head_x_position,
	apache_stinger_seeker_head_y_position;



void initialise_apache_weapon_systems (void)
{
	seeker_head_theta1 = 0.0;

	seeker_head_theta2 = 0.0;

	apache_stinger_seeker_head_x_position = 0.0;

	apache_stinger_seeker_head_y_position = 0.0;
}
...
void update_apache_weapon_systems (void)
{
	int
		inhibit_launch;
	...
	apache_stinger_seeker_head_x_position = 0.25 * sin (seeker_head_theta1);
	apache_stinger_seeker_head_y_position = 0.25 * cos (seeker_head_theta1);

	apache_stinger_seeker_head_x_position += 0.125 * sin (seeker_head_theta2);
	apache_stinger_seeker_head_y_position += 0.125 * cos (seeker_head_theta2);
...
float get_apache_missile_flight_time (void)
{
	entity_sub_types
		weapon_sub_type;
...
void toggle_apache_radar_jammer_manual (void)
{
	...
	play_common_cpg_radar_jammer_speech (apache_damage.radar_jammer);
}
...
void set_apache_radar_jammer_manual (int state)
{
	if (!apache_damage.radar_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_apache_radar_jammer_auto (int state)
{
	if (!apache_damage.radar_jammer)
	{
		if (get_global_auto_counter_measures ())
...
void toggle_apache_infra_red_jammer_manual (void)
{
	...
	play_common_cpg_infra_red_jammer_speech (apache_damage.infra_red_jammer);
}
...
void set_apache_infra_red_jammer_manual (int state)
{
	if (!apache_damage.infra_red_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_apache_infra_red_jammer_auto (int state)
{
	if (!apache_damage.infra_red_jammer)
	{
		if (get_global_auto_counter_measures ())
