...
void initialise_apache_threat_warning_system (void)
{
...
void deinitialise_apache_threat_warning_system (void)
{
...
void activate_apache_threat_warning_system (entity *threat)
{
	ASSERT (threat);
...
void update_apache_threat_warning_system (void)
{
	int
		radar_jammer_on,
		infra_red_jammer_on;
	...
	set_apache_radar_jammer_auto (radar_jammer_on);

	set_apache_infra_red_jammer_auto (infra_red_jammer_on);
