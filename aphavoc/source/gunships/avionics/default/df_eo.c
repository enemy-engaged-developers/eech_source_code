...
void initialise_default_eo (void)
{
	...
	default_flir.field_of_view		= EO_FOV_WIDE;
	default_flir.min_field_of_view	= EO_FOV_ZOOM;
	default_flir.max_field_of_view	= EO_FOV_WIDE;

	default_dtv.field_of_view		= EO_FOV_MEDIUM;
	default_dtv.min_field_of_view	= EO_FOV_NARROW;
	default_dtv.max_field_of_view	= EO_FOV_MEDIUM;

	default_dvo.field_of_view		= EO_FOV_MEDIUM;
	default_dvo.min_field_of_view	= EO_FOV_MEDIUM;
	default_dvo.max_field_of_view	= EO_FOV_WIDE;
};
...
void deinitialise_default_eo (void)
{
}
...
void get_default_eo_centred_viewpoint (viewpoint *vp)
{
	entity
		*source;
...
void update_default_eo (eo_params *eo)
{
	float
		fine_slew_rate,
		medium_slew_rate,
...
void animate_default_eo (object_3d_instance *inst3d)
{
	object_3d_sub_object_search_data
		search_heading,
		search_pitch;
...
void inc_default_eo_zoom(void)
{
	switch (eo_sensor)
	{
		case TARGET_ACQUISITION_SYSTEM_FLIR:
			dec_eo_field_of_view(&default_flir);
			break;
		case TARGET_ACQUISITION_SYSTEM_DTV:
			dec_eo_field_of_view(&default_dtv);
			break;
		default:
			break;
	}
...
void dec_default_eo_zoom(void)
{
	switch (eo_sensor)
	{
		case TARGET_ACQUISITION_SYSTEM_FLIR:
			inc_eo_field_of_view(&default_flir);
			break;
		case TARGET_ACQUISITION_SYSTEM_DTV:
			inc_eo_field_of_view(&default_dtv);
			break;
		default:
			break;
	}
...
void toggle_default_eo_system(void)
{
	switch (eo_sensor)
	{
	case TARGET_ACQUISITION_SYSTEM_FLIR:
...
void slave_default_eo_to_current_target (void)
{
	...
	if (eo_on_target)
	{
		switch (eo_sensor)
		{
			case TARGET_ACQUISITION_SYSTEM_FLIR:
			{
				default_flir.field_of_view = default_flir.min_field_of_view;
				break;
			}
			case TARGET_ACQUISITION_SYSTEM_DTV:
			{
				default_dtv.field_of_view = default_dtv.min_field_of_view;
				break;
			}
			case TARGET_ACQUISITION_SYSTEM_DVO:
			{
				default_dvo.field_of_view = default_dvo.min_field_of_view;
				break;
			}
		}
	}
	else
	{
		switch (eo_sensor)
		{
			case TARGET_ACQUISITION_SYSTEM_FLIR:
			{
				default_flir.field_of_view = default_flir.max_field_of_view;
				break;
			}
			case TARGET_ACQUISITION_SYSTEM_DTV:
			{
				default_dtv.field_of_view = default_dtv.max_field_of_view;
				break;
			}
			case TARGET_ACQUISITION_SYSTEM_DVO:
			{
				default_dvo.field_of_view = default_dvo.max_field_of_view;
				break;
			}
		}
	}
