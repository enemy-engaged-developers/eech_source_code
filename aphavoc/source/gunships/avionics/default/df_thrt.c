...
void initialise_default_threat_warning_system (void)
{
...
void deinitialise_default_threat_warning_system (void)
{
...
void activate_default_threat_warning_system (entity *threat)
{
	ASSERT (threat);
...
void update_default_threat_warning_system (void)
{
	int
		radar_jammer_on,
		infra_red_jammer_on;
	...
	set_default_radar_jammer_auto (radar_jammer_on);

	set_default_infra_red_jammer_auto (infra_red_jammer_on);
