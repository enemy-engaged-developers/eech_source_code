...
extern void draw_mfd_layout_grid (void);

extern void eo_3d_texture_merge (screen *eo_3d_texture_screen, screen *eo_3d_texture_screen_over);

extern void draw_mfd_automatics_marks (int draw_large_mfd, int eo_ground_stabilised);
