...
void initialise_ka50_threat_warning_system (void)
{
...
void deinitialise_ka50_threat_warning_system (void)
{
...
void activate_ka50_threat_warning_system (entity *threat)
{
	ASSERT (threat);
...
void update_ka50_threat_warning_system (void)
{
	int
		radar_jammer_on,
		infra_red_jammer_on;
	...
	set_ka50_radar_jammer_auto (radar_jammer_on);

	set_ka50_infra_red_jammer_auto (infra_red_jammer_on);
