...
static void deselect_ka50_target_acquisition_system (target_acquisition_systems system)
{
	switch (system)
	{
		////////////////////////////////////////
...
void select_ka50_target_acquisition_system (target_acquisition_systems system)
{
	...
	switch (system)
	{
		...
		////////////////////////////////////////
		{
			...
			damaged = ka50_damage.helmet_mounted_sight;
...
void update_ka50_target_acquisition_system (void)
{
	if (ka50_damage.helmet_mounted_sight)
	{
...
void centre_ka50_target_acquisition_system (void)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
...
void toggle_ka50_lock_target (void)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
...
void set_ka50_lock_target (int lock)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
