...
void initialise_ka50_ekran_display (void)
{
...
void deinitialise_ka50_ekran_display (void)
{
...
void update_ka50_ekran_display (void)
{
	...
	set_ka50_ekran_display_text (NULL, NULL, s1, s2);
}
...
void draw_ka50_ekran_display_on_cockpit (float x_org, float y_org)
{
...
void draw_ka50_ekran_display_on_texture (void)
{
...
void set_ka50_ekran_display_text (char *s1, char *s2, char *s3, char *s4)
{
	if (s1)
	{
