...
float
	comanche_stinger_seeker_head_x_position,
	comanche_stinger_seeker_head_y_position;



void initialise_comanche_weapon_systems (void)
{
	seeker_head_theta1 = 0.0;

	seeker_head_theta2 = 0.0;

	comanche_stinger_seeker_head_x_position = 0.0;

	comanche_stinger_seeker_head_y_position = 0.0;
}
...
void update_comanche_weapon_systems (void)
{
	int
		inhibit_launch;
	...
	comanche_stinger_seeker_head_x_position = 0.25 * sin (seeker_head_theta1);
	comanche_stinger_seeker_head_y_position = 0.25 * cos (seeker_head_theta1);

	comanche_stinger_seeker_head_x_position += 0.125 * sin (seeker_head_theta2);
	comanche_stinger_seeker_head_y_position += 0.125 * cos (seeker_head_theta2);
...
float get_comanche_missile_flight_time (void)
{
	entity_sub_types
		weapon_sub_type;
...
void toggle_comanche_radar_jammer_manual (void)
{
	...
	play_common_cpg_radar_jammer_speech (comanche_damage.radar_jammer);
}
...
void set_comanche_radar_jammer_manual (int state)
{
	if (!comanche_damage.radar_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_comanche_radar_jammer_auto (int state)
{
	if (!comanche_damage.radar_jammer)
	{
		if (get_global_auto_counter_measures ())
...
void toggle_comanche_infra_red_jammer_manual (void)
{
	...
	play_common_cpg_infra_red_jammer_speech (comanche_damage.infra_red_jammer);
}
...
void set_comanche_infra_red_jammer_manual (int state)
{
	if (!comanche_damage.infra_red_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_comanche_infra_red_jammer_auto (int state)
{
	if (!comanche_damage.infra_red_jammer)
	{
		if (get_global_auto_counter_measures ())
