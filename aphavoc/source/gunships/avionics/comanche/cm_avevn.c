...
{
	inc_comanche_eo_zoom();
}

static void dec_eo_zoom_event (event *ev)
{
	dec_comanche_eo_zoom();
}
...
{
	if (!laser_is_active() && !comanche_damage.laser_designator && get_local_entity_parent (get_gunship_entity (), LIST_TYPE_TARGET))
