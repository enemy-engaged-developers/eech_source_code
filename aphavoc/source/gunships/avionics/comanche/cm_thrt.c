...
void initialise_comanche_threat_warning_system (void)
{
...
void deinitialise_comanche_threat_warning_system (void)
{
...
void activate_comanche_threat_warning_system (entity *threat)
{
	ASSERT (threat);
	...
	switch (get_local_entity_int_value (threat, INT_TYPE_THREAT_TYPE))
	{
		...
		////////////////////////////////////////
		{
			if (!comanche_damage.radar_warning_system)
			{
				...
				auto_page_comanche_ase_main_mfd ();
...
void update_comanche_threat_warning_system (void)
{
	int
		radar_jammer_on,
		infra_red_jammer_on;
	...
	set_comanche_radar_jammer_auto (radar_jammer_on);

	set_comanche_infra_red_jammer_auto (infra_red_jammer_on);
