...
float
	viper_sidewinder_seeker_head_x_position,
	viper_sidewinder_seeker_head_y_position;



void initialise_viper_weapon_systems (void)
{
	seeker_head_theta1 = 0.0;

	seeker_head_theta2 = 0.0;

	viper_sidewinder_seeker_head_x_position = 0.0;

	viper_sidewinder_seeker_head_y_position = 0.0;
}
...
void update_viper_weapon_systems (void)
{
	int
		inhibit_launch;
	...
	////////////////////////////////////////
	//
	// Sidewinder lock tone
	//
	////////////////////////////////////////

	if ((weapon_sub_type == ENTITY_SUB_TYPE_WEAPON_AIM9M_SIDEWINDER) && (weapon_lock_type == WEAPON_LOCK_VALID))
	{
	...
	////////////////////////////////////////
	//
	// Sidewinder seeker head position
	//
	////////////////////////////////////////

	viper_sidewinder_seeker_head_x_position = 0.25 * sin (seeker_head_theta1);
	viper_sidewinder_seeker_head_y_position = 0.25 * cos (seeker_head_theta1);

	viper_sidewinder_seeker_head_x_position += 0.125 * sin (seeker_head_theta2);
	viper_sidewinder_seeker_head_y_position += 0.125 * cos (seeker_head_theta2);
...
void set_viper_radar_jammer_manual (int state)
{
	if (!viper_damage.radar_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_viper_radar_jammer_auto (int state)
{
	if (!viper_damage.radar_jammer)
	{
		if (get_global_auto_counter_measures ())
...
void toggle_viper_infra_red_jammer_manual (void)
{
	...
	play_common_cpg_infra_red_jammer_speech (viper_damage.infra_red_jammer);
}
...
void set_viper_infra_red_jammer_manual (int state)
{
	if (!viper_damage.infra_red_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_viper_infra_red_jammer_auto (int state)
{
	if (!viper_damage.infra_red_jammer)
	{
		if (get_global_auto_counter_measures ())
