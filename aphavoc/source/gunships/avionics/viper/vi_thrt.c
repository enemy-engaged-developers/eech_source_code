...
void initialise_viper_threat_warning_system (void)
{
...
void deinitialise_viper_threat_warning_system (void)
{
...
void activate_viper_threat_warning_system (entity *threat)
{
	ASSERT (threat);
...
void update_viper_threat_warning_system (void)
{
	int
		radar_jammer_on,
		infra_red_jammer_on;
	...
	set_viper_radar_jammer_auto (radar_jammer_on);

	set_viper_infra_red_jammer_auto (infra_red_jammer_on);
