...
void update_hind_weapon_systems (void)
{
	int
		inhibit_launch;
...
float get_hind_missile_flight_time (void)
{
	entity
		*en,
		*weapon,
...
void toggle_hind_radar_jammer_manual (void)
{
	...
	play_common_cpg_radar_jammer_speech (hind_damage.radar_jammer);
}
...
void set_hind_radar_jammer_manual (int state)
{
	if (!hind_damage.radar_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_hind_radar_jammer_auto (int state)
{
	if (!hind_damage.radar_jammer)
	{
		if (get_global_auto_counter_measures ())
...
void toggle_hind_infra_red_jammer_manual (void)
{
	...
	play_common_cpg_infra_red_jammer_speech (hind_damage.infra_red_jammer);
}
...
void set_hind_infra_red_jammer_manual (int state)
{
	if (!hind_damage.infra_red_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_hind_infra_red_jammer_auto (int state)
{
	if (!hind_damage.infra_red_jammer)
	{
		if (get_global_auto_counter_measures ())
