...
void initialise_hind_threat_warning_system (void)
{
...
void deinitialise_hind_threat_warning_system (void)
{
...
void activate_hind_threat_warning_system (entity *threat)
{
	ASSERT (threat);
...
void update_hind_threat_warning_system (void)
{
	int
		radar_jammer_on,
		infra_red_jammer_on;
	...
	set_hind_radar_jammer_auto (radar_jammer_on);

	set_hind_infra_red_jammer_auto (infra_red_jammer_on);
