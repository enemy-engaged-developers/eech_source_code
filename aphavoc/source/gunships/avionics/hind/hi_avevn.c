...
{
	centre_hind_target_acquisition_system ();
}
...
{
	hind_target_acquisition_system_misc_function1 ();
}*/
...
{
	hind_target_acquisition_system_misc_function2 ();
}*/
...
{
	toggle_hind_infra_red_jammer_manual ();
}
...
static void select_eo_view_event (event *ev)
{
...
static void toggle_cockpit_fan_event(event* ev)
{
	toggle_mi24_cockpit_fan();
}
...
static void toggle_map_on_off_event(event* ev)
{
	toggle_mi24_map();
}
...
void set_hind_avionics_events (void)
{
	...
	set_event (DIK_DELETE, MODIFIER_NONE, KEY_STATE_DOWN, select_target_acquisition_system_dtv_event);
	...
	set_event (DIK_NEXT, MODIFIER_NONE, KEY_STATE_DOWN, select_eo_view_event);
	...
	set_event (DIK_4, MODIFIER_LEFT_SHIFT, KEY_STATE_DOWN, select_target_acquisition_system_dtv_event);
...
//	set_event (DIK_NUMPADENTER, MODIFIER_LEFT_ALT, KEY_STATE_DOWN, toggle_lock_target_event); // Jabberwock 031107 Designated targets
	...
	set_event (DIK_O, MODIFIER_NONE, KEY_STATE_DOWN, toggle_backup_sight_event);
	...
	set_event (DIK_Y, MODIFIER_LEFT_CONTROL, KEY_STATE_DOWN, toggle_cockpit_fan_event);

	set_event (DIK_RBRACKET, MODIFIER_LEFT_CONTROL, KEY_STATE_DOWN, toggle_map_on_off_event);
