...
void initialise_havoc_ekran_display (void)
{
...
void deinitialise_havoc_ekran_display (void)
{
...
void update_havoc_ekran_display (void)
{
	char
		s1[80],
		s2[80];
	...
	set_havoc_ekran_display_text (NULL, NULL, s1, s2);
}
...
void draw_havoc_ekran_display_on_cockpit (float x_org, float y_org)
{
...
void draw_havoc_ekran_display_on_texture (void)
{
...
void set_havoc_ekran_display_text (char *s1, char *s2, char *s3, char *s4)
{
	if (s1)
	{
	...
	if (command_line_shared_mem_export != 0)
		update_ekran_shared_mem(s1, s2, s3, s4); // Retro 14Aug2006
}
