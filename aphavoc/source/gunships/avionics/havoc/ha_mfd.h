...
extern void initialise_havoc_mfd (void);
...
extern void draw_overlaid_havoc_mfd (float x_org, float y_org, float size);

extern int get_havoc_eo_display_visible (void);

extern void draw_engine_mfd_on_texture (void);
