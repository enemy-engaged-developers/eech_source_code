...
void initialise_kiowa_threat_warning_system (void)
{
...
void activate_kiowa_threat_warning_system (entity *threat)
{
	ASSERT (threat);
...
void update_kiowa_threat_warning_system (void)
{
	int
		infra_red_jammer_on;
	...
	set_kiowa_infra_red_jammer_auto (infra_red_jammer_on);
