...
float
	kiowa_stinger_seeker_head_x_position,
	kiowa_stinger_seeker_head_y_position;



void initialise_kiowa_weapon_systems (void)
{
	seeker_head_theta1 = 0.0;

	seeker_head_theta2 = 0.0;

	kiowa_stinger_seeker_head_x_position = 0.0;

	kiowa_stinger_seeker_head_y_position = 0.0;
}
...
void update_kiowa_weapon_systems (void)
{
	int
		inhibit_launch;
	...
	kiowa_stinger_seeker_head_x_position = 0.25 * sin (seeker_head_theta1);
	kiowa_stinger_seeker_head_y_position = 0.25 * cos (seeker_head_theta1);

	kiowa_stinger_seeker_head_x_position += 0.125 * sin (seeker_head_theta2);
	kiowa_stinger_seeker_head_y_position += 0.125 * cos (seeker_head_theta2);
...
float get_kiowa_missile_flight_time (void)
{
	entity_sub_types
		weapon_sub_type;
...
void toggle_kiowa_infra_red_jammer_manual (void)
{
	...
	play_common_cpg_infra_red_jammer_speech (kiowa_damage.infra_red_jammer);
}
...
void set_kiowa_infra_red_jammer_manual (int state)
{
	if (!kiowa_damage.infra_red_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_kiowa_infra_red_jammer_auto (int state)
{
	if (!kiowa_damage.infra_red_jammer)
	{
		if (get_global_auto_counter_measures ())
