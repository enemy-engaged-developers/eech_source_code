...
void activate_kiowa_master_caution (void)
{
	kiowa_lamps.master_caution = 1;
...
void deactivate_kiowa_master_caution (void)
{
	kiowa_lamps.master_caution = 0;
...
//
// Note that all lamps are extinguished in initialise_kiowa_lamps ().
//

void initialise_kiowa_lamp_avionics (void)
{
...
void deinitialise_kiowa_lamp_avionics (void)
{
