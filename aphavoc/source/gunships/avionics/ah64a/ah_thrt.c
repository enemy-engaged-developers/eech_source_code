...
void initialise_ah64a_threat_warning_system (void)
{
...
void deinitialise_ah64a_threat_warning_system (void)
{
...
void activate_ah64a_threat_warning_system (entity *threat)
{
	ASSERT (threat);
...
void update_ah64a_threat_warning_system (void)
{
	int
		radar_jammer_on,
		infra_red_jammer_on;
	...
	set_ah64a_radar_jammer_auto (radar_jammer_on);

	set_ah64a_infra_red_jammer_auto (infra_red_jammer_on);
