...
{
	select_ah64a_mfd_mode (MFD_MODE_FLIGHT, MFD_LOCATION_LHS);
}
...
{
	select_ah64a_mfd_mode (MFD_MODE_FLIGHT, MFD_LOCATION_RHS);
}
...
{
	if (!laser_is_active() && !ah64a_damage.laser_designator)
