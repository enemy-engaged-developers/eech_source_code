...
void initialise_ah64a_upfront_display (void)
{
...
void deinitialise_ah64a_upfront_display (void)
{
...
void update_ah64a_upfront_display (void)
{
	char
		s1[80],
		s2[80];
	...
	set_ah64a_upfront_display_text (NULL, NULL, s1, s2);
}
...
void draw_ah64a_upfront_display_on_cockpit (float x_org, float y_org)
{
...
void draw_ah64a_upfront_display_on_texture (void)
{
...
void set_ah64a_upfront_display_text (char *s1, char *s2, char *s3, char *s4)
{
	if (s1)
	{
