...
float
	ah64a_stinger_seeker_head_x_position,
	ah64a_stinger_seeker_head_y_position;



void initialise_ah64a_weapon_systems (void)
{
	seeker_head_theta1 = 0.0;

	seeker_head_theta2 = 0.0;

	ah64a_stinger_seeker_head_x_position = 0.0;

	ah64a_stinger_seeker_head_y_position = 0.0;
}
...
void update_ah64a_weapon_systems (void)
{
	int
		inhibit_launch;
	...
	ah64a_stinger_seeker_head_x_position = 0.25 * sin (seeker_head_theta1);
	ah64a_stinger_seeker_head_y_position = 0.25 * cos (seeker_head_theta1);
...
float get_ah64a_missile_flight_time (void)
{
	entity_sub_types
		weapon_sub_type;
...
void toggle_ah64a_radar_jammer_manual (void)
{
	...
	play_common_cpg_radar_jammer_speech (ah64a_damage.radar_jammer);
}
...
void set_ah64a_radar_jammer_manual (int state)
{
	if (!ah64a_damage.radar_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_ah64a_radar_jammer_auto (int state)
{
	if (!ah64a_damage.radar_jammer)
	{
		if (get_global_auto_counter_measures ())
...
void toggle_ah64a_infra_red_jammer_manual (void)
{
	...
	play_common_cpg_infra_red_jammer_speech (ah64a_damage.infra_red_jammer);
}
...
void set_ah64a_infra_red_jammer_manual (int state)
{
	if (!ah64a_damage.infra_red_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_ah64a_infra_red_jammer_auto (int state)
{
	if (!ah64a_damage.infra_red_jammer)
	{
		if (get_global_auto_counter_measures ())
