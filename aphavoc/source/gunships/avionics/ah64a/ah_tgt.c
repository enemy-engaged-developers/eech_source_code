...
void initialise_ah64a_target_acquisition_systems (void)
{
	initialise_ah64a_radar ();

	initialise_ah64a_eo ();

	initialise_ah64a_hms ();
}
...
void deinitialise_ah64a_target_acquisition_systems (void)
{
	deinitialise_ah64a_radar ();

	deinitialise_ah64a_eo ();

	deinitialise_ah64a_hms ();
}
...
static void deselect_ah64a_target_acquisition_system (target_acquisition_systems system)
{
	switch (system)
	{
		////////////////////////////////////////
...
void select_ah64a_target_acquisition_system (target_acquisition_systems system)
{
	...
	deselect_ah64a_target_acquisition_system (target_acquisition_system);
...
void update_ah64a_target_acquisition_system (void)
{
...
void centre_ah64a_target_acquisition_system (void)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
...
void toggle_ah64a_show_allied_targets (void)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
...
void toggle_ah64a_auto_target (void)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
...
void toggle_ah64a_lock_target (void)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
...
void set_ah64a_lock_target (int lock)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
...
void ah64a_target_acquisition_system_misc_function1 (void)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
...
void ah64a_target_acquisition_system_misc_function2 (void)
{
	switch (target_acquisition_system)
	{
		////////////////////////////////////////
