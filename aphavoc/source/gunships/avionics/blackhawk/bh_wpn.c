...
void toggle_blackhawk_radar_jammer_manual (void)
{
	...
	play_common_cpg_radar_jammer_speech (blackhawk_damage.radar_jammer);
}
...
void set_blackhawk_radar_jammer_manual (int state)
{
	if (!blackhawk_damage.radar_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_blackhawk_radar_jammer_auto (int state)
{
	if (!blackhawk_damage.radar_jammer)
	{
		if (get_global_auto_counter_measures ())
