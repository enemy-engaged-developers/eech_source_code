...
/*static void select_target_acquisition_system_ground_radar_event (event *ev)
{
	...
	{
		select_blackhawk_target_acquisition_system (TARGET_ACQUISITION_SYSTEM_GROUND_RADAR);
	}
}*/
...
/*static void select_target_acquisition_system_air_radar_event (event *ev)
{
	if (!get_global_simple_avionics ())
	{
		select_blackhawk_target_acquisition_system (TARGET_ACQUISITION_SYSTEM_AIR_RADAR);
	}
}*/
...
static void select_target_acquisition_system_dvo_event (event *ev)
{
	if (!get_global_simple_avionics ())
	{
		select_blackhawk_target_acquisition_system (TARGET_ACQUISITION_SYSTEM_DVO);
	}
}
...
{
	blackhawk_target_acquisition_system_misc_function1 ();
}*/
...
{
	blackhawk_target_acquisition_system_misc_function2 ();
}*/
...
{
	select_next_blackhawk_tsd_ase_range ();
}
...
{
	select_previous_blackhawk_tsd_ase_range ();
}
...
{
	select_next_blackhawk_tsd_declutter_level ();
}
...
{
	select_previous_blackhawk_tsd_declutter_level ();
}
...
{
	select_previous_blackhawk_lhs_mfd ();
}
...
{
	select_previous_blackhawk_rhs_mfd ();
}
...
/*static void select_lhs_tads_mfd_event (event *ev)
{
	...
	{
		select_blackhawk_mfd_mode (MFD_MODE_FLIR, MFD_LOCATION_LHS);
	}
	else if (eo_sensor == TARGET_ACQUISITION_SYSTEM_DTV)
	{
		select_blackhawk_mfd_mode (MFD_MODE_DTV, MFD_LOCATION_LHS);
	}
	else
	{
		select_blackhawk_mfd_mode (MFD_MODE_DVO, MFD_LOCATION_LHS);
	}
}*/
...
/*static void select_rhs_tads_mfd_event (event *ev)
{
	if (eo_sensor == TARGET_ACQUISITION_SYSTEM_FLIR)
	{
		select_blackhawk_mfd_mode (MFD_MODE_FLIR, MFD_LOCATION_RHS);
	}
	else if (eo_sensor == TARGET_ACQUISITION_SYSTEM_DTV)
	{
		select_blackhawk_mfd_mode (MFD_MODE_DTV, MFD_LOCATION_RHS);
	}
	else
	{
		select_blackhawk_mfd_mode (MFD_MODE_DVO, MFD_LOCATION_RHS);
	}
}*/
...
{
	select_blackhawk_mfd_mode (MFD_MODE_TSD, MFD_LOCATION_LHS);
}
...
{
	select_blackhawk_mfd_mode (MFD_MODE_WEAPON, MFD_LOCATION_LHS);
}
...
{
	select_blackhawk_mfd_mode (MFD_MODE_WEAPON, MFD_LOCATION_RHS);
}
...
{
	select_blackhawk_mfd_mode (MFD_MODE_SYSTEM, MFD_LOCATION_LHS);
}
...
{
	select_blackhawk_mfd_mode (MFD_MODE_SYSTEM, MFD_LOCATION_RHS);
}
...
{
	select_blackhawk_mfd_mode (MFD_MODE_ENGINE, MFD_LOCATION_RHS);
}
...
{
	toggle_blackhawk_lhs_mfd_on_off ();
}
...
{
	toggle_blackhawk_rhs_mfd_on_off ();
}
...
{
	toggle_blackhawk_radar_jammer_manual ();
}
