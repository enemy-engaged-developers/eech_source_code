...
void initialise_hokum_threat_warning_system (void)
{
...
void deinitialise_hokum_threat_warning_system (void)
{
...
void activate_hokum_threat_warning_system (entity *threat)
{
	ASSERT (threat);
...
void update_hokum_threat_warning_system (void)
{
	int
		radar_jammer_on,
		infra_red_jammer_on;
	...
	set_hokum_radar_jammer_auto (radar_jammer_on);

	set_hokum_infra_red_jammer_auto (infra_red_jammer_on);
