...
void update_hokum_weapon_systems (void)
{
	int
		inhibit_launch;
...
float get_hokum_missile_flight_time (void)
{
	entity
		*en,
		*weapon,
	...
	while (weapon)
	{
		if (get_local_entity_int_value (weapon, INT_TYPE_ENTITY_SUB_TYPE) == ENTITY_SUB_TYPE_WEAPON_9K121_VIKHR)
		{
...
void toggle_hokum_radar_jammer_manual (void)
{
	...
	play_common_cpg_radar_jammer_speech (hokum_damage.radar_jammer);
}
...
void set_hokum_radar_jammer_manual (int state)
{
	if (!hokum_damage.radar_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_hokum_radar_jammer_auto (int state)
{
	if (!hokum_damage.radar_jammer)
	{
		if (get_global_auto_counter_measures ())
...
void toggle_hokum_infra_red_jammer_manual (void)
{
	...
	play_common_cpg_infra_red_jammer_speech (hokum_damage.infra_red_jammer);
}
...
void set_hokum_infra_red_jammer_manual (int state)
{
	if (!hokum_damage.infra_red_jammer)
	{
		if (!get_global_auto_counter_measures ())
...
void set_hokum_infra_red_jammer_auto (int state)
{
	if (!hokum_damage.infra_red_jammer)
	{
		if (get_global_auto_counter_measures ())
