...
void initialise_kiowa_advanced_dynamics (entity *en)
{
	ASSERT (en);
	...
	if (command_line_dynamics_flight_model != 2)
		...
		sprintf (current_flight_dynamics->filename, "..\\common\\data\\dynamics\\kiowa.dyn");
}
...
void update_kiowa_advanced_dynamics (void)
{
...
void kiowa_restore_damage_values (void)
{
