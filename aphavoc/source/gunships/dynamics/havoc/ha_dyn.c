...
void initialise_havoc_advanced_dynamics (entity *en)
{
	...
	sprintf (current_flight_dynamics->filename, "..\\common\\data\\havoc.dyn");
}
...
void update_havoc_advanced_dynamics (void)
{
...
void havoc_restore_damage_values (void)
{
