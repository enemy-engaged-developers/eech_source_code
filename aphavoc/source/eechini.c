...
static const struct config_option options[] =
{
	...
	{ "maxfov1", "", "general field of view maximum for Havoc pits",
		INT(command_line_max_fov1) },
	{ "maxfov2", "", "general field of view maximum for Comanche pits",
		INT(command_line_max_fov2) },
	{ "maxfov3", "", "general field of view maximum for Hokum-B pits",
	...
	{  "apache_copilot", "", "wideview pilot position",
	...
	{  "hind_copilot", "", "wideview pilot position",
