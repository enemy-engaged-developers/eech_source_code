...
#define DEFAULT_GWUT_FILE "GWUT1161.CSV"
...
//		INT(command_line_eo_full_range) },
	...
	{ "noitm", "", "no intro music (0 = off, 1 = on) (def = 0)",
		INT(command_line_no_intro_music) },
	{ "noigm", "", "no ingame music (0 = off, 1 = on) (def = 0)",
		INT(command_line_no_ingame_music) },
	{ "noam", "", "no action music (0 = off, 1 = on) (def = 0)",
		INT(command_line_no_action_music) },
